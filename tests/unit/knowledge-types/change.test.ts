    ...
    it('should validate complete change with all fields', () => {
      const change = {
        ...
        data: {
          ...
          details: 'Implemented complete authentication flow including login, logout, password reset, and token refresh functionality',
          affected_files: [
    ...
    it('should store change successfully using memory_store pattern', async () => {
      const change = {
        ...
        data: {
          ...
          details: 'Updated React, TypeScript, ESLint, and other major dependencies to improve security and performance',
    ...
    it('should handle complex changes with many affected files', async () => {
      const complexChange = {
        ...
        data: {
          ...
          details: 'Comprehensive refactoring to implement event-driven architecture, replace REST calls with message queues, add circuit breakers, and improve observability',
          affected_files: [
      ...
      const changes = [
        {
          ...
          data: {
            ...
            details: 'Implemented GraphQL resolvers, subscription handlers, WebSocket connections, and Apollo Server configuration. Features include: @defer directives, @stream, real-time notifications, and query batching optimization.'
          },
    ...
    it('should integrate with knowledge item validation', () => {
      const change = {
        ...
        data: {
          ...
          details: 'Removed legacy payment service in favor of new payment gateway. All references have been updated and database migration completed.',
          affected_files: [
    ...
    it('should handle changes with comprehensive metadata', () => {
      const change = {
        ...
        data: {
          ...
          details: 'Updated all packages to latest secure versions, addressing 12 CVEs across React ecosystem and Node.js dependencies',
          affected_files: ['package.json', 'package-lock.json', 'yarn.lock'],
