/**
 * Comprehensive Unit Tests for Transaction Handling Utilities (Fixed Singleton Mocking)
 *
...
// Mock dependencies at module level BEFORE importing the transaction utilities
const mockLogger = {
  debug: vi.fn(),
  warn: vi.fn(),
  error: vi.fn(),
...
vi.mock('../../../src/utils/db-error-handler.js', () => ({
  DatabaseErrorHandler: vi.fn().mockImplementation(() => mockDbErrorHandler),
  dbErrorHandler: mockDbErrorHandler,
...
describe('Transaction Handling Utilities', () => {
  ...
  beforeEach(() => {
    ...
    mockDbErrorHandler.categorizeError.mockReturnValue('UNKNOWN_ERROR');
  });
  ...
  describe('executeTransaction', () => {
    ...
    it('should retry on retryable errors', async () => {
      ...
      mockDbErrorHandler.categorizeError
    ...
    it('should fail after max retries exceeded', async () => {
      ...
      mockDbErrorHandler.categorizeError.mockReturnValue('CONFLICT');
    ...
    it('should not retry on non-retryable errors', async () => {
      ...
      mockDbErrorHandler.categorizeError.mockReturnValue('CONSTRAINT_VIOLATION');
  ...
  describe('Error Handling and Edge Cases', () => {
    it('should handle transaction timeout errors', async () => {
      ...
      mockDbErrorHandler.categorizeError.mockReturnValue('TIMEOUT_ERROR');
    ...
    it('should handle deadlock errors', async () => {
      ...
      mockDbErrorHandler.categorizeError.mockReturnValue('DEADLOCK');
    ...
    it('should handle connection pool exhaustion', async () => {
      ...
      mockDbErrorHandler.categorizeError.mockReturnValue('CONNECTION_ERROR');
