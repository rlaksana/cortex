  ...
  for (const file of files) {
    ...
    const newLines = lines.map(line => {
      ...
      if (importMatch) {
        ...
        console.log(`[${file}] Checking import: ${importPath} in line: ${line}`);
        if (!path.extname(importPath)) {
            ...
            if (importPath.startsWith('@/')) {
                ...
                if (paths[alias]) {
                    ...
                    console.log(`[${file}] Alias: ${alias}, RealPath: ${realPath}, RestOfPath: ${restOfPath}, AbsoluteImportPath: ${absoluteImportPath}`);
