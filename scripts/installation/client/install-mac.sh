...
#######################################################################
# MCP Cortex Client Installer for macOS
#
# Usage: ./install-mac.sh <server-ip> [port] [password]
# Example: ./install-mac.sh 192.168.1.100 5433 my-password
#
# Version: 1.0.0
#######################################################################
...
section "MCP CORTEX CLIENT INSTALLER FOR MACOS"
...
if ! command -v jq &> /dev/null; then
    warning "jq not found - using python fallback"
