...
export class InsightGenerationGuardrails {
   ...
   */
  validateTokenLimits(insights: InsightTypeUnion[]): {
    valid: boolean;
   ...
   */
  getProvenance(insightId: string): InsightProvenance | null {
  ...
  private estimateTokens(insight: InsightTypeUnion): number {
  ...
  private truncateInsight(insight: InsightTypeUnion, maxTokens: number): InsightTypeUnion {
