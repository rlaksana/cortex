...
`,
  ...
  private async sendSendGrid(email: EmailContent, config: EmailConfig): Promise<NotificationResult> {
...
export class SlackNotificationChannel implements NotificationChannel {
  ...
  private async sendWebhook(payload: SlackPayload, config: SlackConfig): Promise<NotificationResult> {
  ...
  private async sendBotAPI(payload: SlackPayload, config: SlackConfig): Promise<NotificationResult> {
...
export class PagerDutyNotificationChannel implements NotificationChannel {
  ...
  private async sendEvent(event: PagerDutyEvent, config: PagerDutyConfig): Promise<NotificationResult> {
...
export class TeamsNotificationChannel implements NotificationChannel {
  ...
  private async sendWebhook(payload: TeamsPayload, config: TeamsConfig): Promise<NotificationResult> {
...
export class SNSNotificationChannel implements NotificationChannel {
  ...
  private async publishMessage(message: SNSMessage, config: SNSConfig): Promise<NotificationResult> {
