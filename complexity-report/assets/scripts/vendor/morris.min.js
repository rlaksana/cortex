      ...
      return (
        ...
        (r.prototype.setData = function (e, n) {
          ...
          ((d = this.cumulative ? 0 : null),
                  ...
                  this.options.parseTime
                    ? ((a.x = t.parseDate(a.label)),
                      this.options.dateFormat
                        ...
                        : typeof a.label == 'number' && (a.label = new Date(a.label).toString()))
                    : ((a.x = s),
            ...
            this.ymin === this.ymax && (v && (this.ymin -= 1), (this.ymax += 1)));
        ...
        (r.prototype.yboundary = function (e, t) {
          ...
          return (
            ...
            typeof n == 'string'
              ? n.slice(0, 4) === 'auto'
                ? n.length > 5
                  ? ((r = parseInt(n.slice(5), 10)), t == null ? r : Math[e](t, r))
                  : t != null
                    ? t
                    : 0
                : parseInt(n, 10)
        ...
        (r.prototype.autoGridLines = function (e, t, n) {
          ...
          return (
            ...
            (r = Math.ceil(t / f) * f),
            (a = (r - i) / (n - 1)),
            f === 1 && a > 1 && Math.ceil(a) !== a && ((a = Math.ceil(a)), (r = i + a * (n - 1))),
            i < 0 && r > 0 && ((i = Math.floor(e / a) * a), (r = Math.ceil(t / a) * a)),
            a < 1
        ...
        (r.prototype.drawGrid = function () {
          ...
          for (n = 0, r = i.length; n < r; n++)
            ((e = i[n]),
              ...
              this.options.grid
                ? s.push(
                    this.drawGridLine('M' + this.left + ',' + t + 'H' + (this.left + this.width))
                  )
                : s.push(void 0));
          return s;
        }),
    ...
    (t.parseDate = function (e) {
      ...
      return typeof e == 'number'
        ...
        : ((n = e.match(/^(\d+) Q(\d)$/)),
          ...
          n
            ? new Date(parseInt(n[1], 10), parseInt(n[2], 10) * 3 - 1, 1).getTime()
            : i
              ? new Date(parseInt(i[1], 10), parseInt(i[2], 10) - 1, 1).getTime()
              : s
                ? new Date(parseInt(s[1], 10), parseInt(s[2], 10) - 1, parseInt(s[3], 10)).getTime()
                : u
      ...
      return (
        ...
        (n.prototype.moveTo = function (e, t) {
          ...
          return (
            ...
            t != null
              ? ((u = t - n - 10), u < 0 && ((u = t + 10), u + n > s && (u = s / 2 - n / 2)))
              : (u = s / 2 - n / 2),
    ...
    (t.Line = (function (e) {
      ...
      return (
        ...
        (n.prototype.displayHoverForRow = function (e) {
          var t;
          return e != null
            ? ((t = this.hover).update.apply(t, this.hoverContentForRow(e)), this.hilight(e))
          ...
          return (this.paths = function () {
            ...
            for (
              ...
              ((s =
                ...
                ((f = this.options.ykeys[r]), a.call(this.options.smooth, f) >= 0)),
                (n = function () {
                  var e, t, n, s;
                  ((n = this.data), (s = []));
            ...
            (e = function (e, t) {
              ...
              return (
                ...
                c.options.xLabelAngle !== 0 &&
                  ((a = -0.5 * f.width * Math.cos((c.options.xLabelAngle * Math.PI) / 180)),
                  n.transform('t' + a + ',0...')),
                (r = n.getBBox()),
          ...
          if (this.prevHilight !== null && this.prevHilight !== e)
            for (
              ...
              this.seriesPoints[t][this.prevHilight] &&
                this.seriesPoints[t][this.prevHilight].animate(this.pointShrink);
        ...
        (n.prototype.colorFor = function (e, t, n) {
          return typeof this.options.lineColors == 'function'
            ...
            : n === 'point'
              ? this.options.pointFillColors[t % this.options.pointFillColors.length] ||
    ...
    (t.Area = (function (n) {
      function i(n) {
        ...
        ((s = e.extend({}, r, n)),
          ...
          s.fillOpacity === 'auto' && (s.fillOpacity = s.behaveLikeLine ? 0.8 : 1),
        ...
        (i.prototype.fillForSeries = function (e) {
          ...
          return (
            ...
            Raphael.hsl(
              ...
              Math.min(0.98, this.options.behaveLikeLine ? t.l * 1.2 : t.l * 1.25)
            )
          );
        }),
          ...
          for (e = l = 0, c = this.data.length; 0 <= c ? l < c : l > c; e = 0 <= c ? ++l : --l)
            ((u = this.data[this.data.length - 1 - e]),
              ...
              this.options.xLabelAngle !== 0 &&
                ((i = -0.5 * a.width * Math.cos((this.options.xLabelAngle * Math.PI) / 180)),
                t.transform('t' + i + ',0...')),
        ...
        (r.prototype.colorFor = function (e, t, n) {
          ...
          return typeof this.options.barColors == 'function'
            ? ((r = { x: e.x, y: e.y[t], label: e.label }),
              (i = { index: t, key: this.options.ykeys[t], label: this.options.labels[t] }),
