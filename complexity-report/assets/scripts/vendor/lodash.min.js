...
(function () {
  ...
  function o(n) {
    ...
    for (
      u = f(),
        u['false'] = u['null'] = u['true'] = u.undefined = false,
        o = f(),
        o.k = n,
        o.l = u,
        o.push = e;
  ...
  function s(e) {
    function h(n, t, e) {
      ...
      for (
        var r = -1, u = V[typeof n] && Fe(n), o = u ? u.length : 0;
        ++r < o && ((e = u[r]), false !== t(n[e], e, n));
    ...
    function Z(n, t, e, r, u) {
      ...
      return (
        i &&
          (me.call(n, 'index') && (o.index = n.index), me.call(n, 'input') && (o.input = n.input)),
        t
          ? (r.push(n),
            u.push(o),
    ...
    function tt(n, t, e) {
      ...
      if (
        typeof r == 'undefined' &&
        (De.funcNames && (r = !n.name), (r = r || !De.funcDecomp), !r)
      ) {
        var u = ge.call(n);
      ...
      function t() {
        ...
        return (o || c) && (h || (h = p(arguments)), o && be.apply(h, o), c && h.length < a)
          ...
          : (h || (h = arguments),
            l && (e = n[v]),
            this instanceof t
              ? ((n = nt(e.prototype)), (h = e.apply(n, h)), wt(h) ? h : n)
              : e.apply(n, h));
      }
      var e = n[0],
        r = n[1],
    ...
    function ot(n, t, e, r, u, o) {
      ...
      if (((c = f == $), !c)) {
        ...
        if (
          ...
          (p = t.constructor),
          f != p &&
            !(dt(f) && f instanceof f && dt(p) && p instanceof p) &&
            'constructor' in n &&
            'constructor' in t)
        )
          return false;
    ...
    function it(n, t, e, r, u) {
      (Te(t) ? St : h)(t, function (t, o) {
        ...
        if (t && ((a = Te(t)) || Pe(t))) {
          ...
          if (!i) {
            var c;
            (e && ((f = e(l, t)), (c = typeof f != 'undefined')) && (l = f),
              c || (l = a ? (Te(l) ? l : []) : Pe(l) ? l : {}),
              r.push(t),
              u.push(l),
              c || it(l, t, e, r, u));
          ...
          (e && ((f = e(l, t)), typeof f == 'undefined' && (f = t)),
            typeof f != 'undefined' && (l = f));
        n[o] = l;
      });
    }
    function at(n, t) {
    ...
    function ct(n, t, e, r, u, o) {
      ...
      (f && !e.length && ((t &= -17), (f = e = false)),
        l && !r.length && ((t &= -33), (l = r = false)));
    ...
    function Pt(n, t, e, r) {
      return (
        typeof t != 'boolean' &&
          null != t &&
          ((r = e), (e = typeof t != 'function' && r && r[t] === n ? null : t), (t = false)),
        null != e && (e = J.createCallback(e, r, 3)),
        ft(n, t, e)
      );
    }
    function Kt() {
      for (
        var n = 1 < arguments.length ? arguments : arguments[0],
          t = -1,
          e = n ? At(Ve(n, 'length')) : 0,
          r = Xt(0 > e ? 0 : e);
        ++t < e;
    ...
    function Vt(n, t, e) {
      function r() {
        (c && ve(c),
          (i = c = p = v),
          (g || h !== t) && ((s = Ue()), (a = n.apply(l, o)), c || i || (o = l = null)));
      }
      function u() {
        var e = t - (Ue() - f);
        0 < e
          ...
          : (i && ve(i),
            (e = p),
            (i = c = p = v),
            e && ((s = Ue()), (a = n.apply(l, o)), c || i || (o = l = null)));
      }
      var o,
        i,
        a,
      ...
      if (((t = Ie(0, t) || 0), true === e))
        ...
        wt(e) &&
          ((y = e.leading),
          (h = 'maxWait' in e && (Ie(t, e.maxWait) || 0)),
      ...
      return function () {
        ...
        return (
          m && c ? (c = ve(c)) : c || t === h || (c = _e(u, t)),
          e && ((m = true), (a = n.apply(l, o))),
          !m || c || i || (o = l = null),
          a
        );
      };
    ...
    var $e = je
      ...
      Te =
        ...
        function (n) {
          return (
            (n && typeof n == 'object' && typeof n.length == 'number' && ce.call(n) == $) || false
          );
        },
      Fe = Ne
        ? function (n) {
    ...
    return (
      ...
      (J.bindAll = function (n) {
        for (
          var t = 1 < arguments.length ? ut(arguments, true, false, 1) : bt(n),
            e = -1,
            r = t.length;
          ++e < r;
      ...
      (J.intersection = function () {
        for (
          var e = [], r = -1, u = arguments.length, i = a(), f = st(), p = f === n, s = a();
          ++r < u;
      ...
      (J.throttle = function (n, t, e) {
        ...
        return (
          false === e
            ? (r = false)
            : wt(e) &&
              ((r = 'leading' in e ? e.leading : r), (u = 'trailing' in e ? e.trailing : u)),
          (L.leading = r),
          (L.maxWait = t),
          (L.trailing = u),
          Vt(n, t, L)
      ...
      (J.clone = function (n, t, e, r) {
        return (
          ...
          Z(n, t, typeof e == 'function' && tt(e, r, 1))
        );
      }),
      ...
      (J.random = function (n, t, e) {
        ...
        return (
          null == e &&
            (typeof n == 'boolean' && u
              ? ((e = n), (n = 1))
              : u || typeof t != 'boolean' || ((e = t), (u = true))),
          r && u && (t = 1),
          (n = +n || 0),
          u ? ((t = n), (n = 0)) : (t = +t || 0),
          e || n % 1 || t % 1
            ? ((e = Re()), Se(n + e * (t - n + parseFloat('1e-' + ((e + '').length - 1))), t))
            : at(n, t)
        );
      }),
      (J.reduce = Dt),
      ...
      (J.template = function (n, t, e) {
        ...
        (n.replace(f, function (t, e, r, o, f, c) {
          ...
          (l =
            ...
            (u ? ",__j=Array.prototype.join;function print(){__p+=__j.call(arguments,'')}" : ';') +
            l +
            'return __p}'));
        try {
      ...
      (J.sample = function (n, t, e) {
        return (
          n && typeof n.length != 'number' && (n = xt(n)),
          null == t || e
            ? n
              ? n[at(0, n.length - 1)]
              : v
            : ((n = Tt(n)), (n.length = Se(Ie(0, t), n.length)), n)
        );
      }),
      (J.take = Bt),
      (J.head = Bt),
