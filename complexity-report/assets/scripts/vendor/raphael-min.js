...
((function (a) {
  ...
  (function () {
    ...
    ((a._g = h),
      (a.type =
        h.win.SVGAngle ||
        h.doc.implementation.hasFeature('http://www.w3.org/TR/SVG11/feature#BasicStructure', '1.1')
          ? 'SVG'
          : 'VML'));
    if (a.type == 'VML') {
          ...
          e.length ||
            r(b).replace(Z, function (a, b, c) {
              ...
              (c.replace(_, function (a, b) {
                ...
                g == 'm' &&
                  f.length > 2 &&
                  (e.push([b][n](f.splice(0, 2))), (g = 'l'), (b = b == 'm' ? 'l' : 'L')));
              if (g == 'r') e.push([b][n](f));
              else
                while (f.length >= d[g]) {
    ...
    var bI = (a.pathBBox = function (a) {
      ...
      bV = (a._toback = function (a, b) {
        b.bottom !== a &&
          (bT(a, b), (a.next = b.bottom), (a.prev = null), (b.bottom.prev = a), (b.bottom = a));
      }),
            ...
            (q == 't' && o == 3
              ...
              : q == 'r'
                ? o == 2
                  ...
                  : o == 4 &&
                    (s
                      ? ((w = t.x(n[2], n[3])), (x = t.y(n[2], n[3])), k.rotate(n[1], w, x))
                ...
                : q == 's'
                  ? o == 2 || o == 3
                    ...
                    : o == 5 &&
                      (s
                        ? ((w = t.x(n[3], n[4])), (x = t.y(n[3], n[4])), k.scale(n[1], n[2], w, x))
          ...
          if (d.type == 'path') {
            ...
            if (r != 'none') {
              ...
              a._g.doc.getElementById(A)
                ? p[A]++
                : (h.defs.appendChild(q(q('path'), { 'stroke-linecap': 'round', d: o[r], id: A })),
                  (p[A] = 1));
              ...
              (f
                ? ((s = d._.arrows.startdx * m || 0), (t = a.getTotalLength(k.path) - s))
                : ((s = 0), (t = a.getTotalLength(k.path) - (d._.arrows.enddx * m || 0))),
            ...
            if (f[b](o)) {
              ...
              switch (o) {
                ...
                case 'cy':
                  ...
                  break;
                case 'r':
                  (d.type == 'rect' ? q(i, { rx: p, ry: p }) : i.setAttribute(o, p),
                    (d._.dirty = 1));
                  break;
                case 'src':
                ...
                case 'fill':
                  ...
                  if (!G.error)
                    ...
                    (d.type == 'circle' || d.type == 'ellipse' || c(p).charAt() != 'r') &&
                    r(d, p)
                  ) {
                ...
                case 'stroke':
                  ((G = a.getRGB(p)),
                    ...
                    o == 'stroke' &&
                      G[b]('opacity') &&
                      q(i, { 'stroke-opacity': G.opacity > 1 ? G.opacity / 100 : G.opacity }),
                    o == 'stroke' &&
                      d._.arrows &&
                      ('startString' in d._.arrows && t(d, d._.arrows.startString),
                      'endString' in d._.arrows && t(d, d._.arrows.endString, 1)));
      ...
      ((z.prototype = A),
        ...
        (a._engine.create = function () {
          ...
          ((d = d || 0),
            ...
            c == 1
              ? ((h.style.cssText = i + 'position:absolute;left:' + d + 'px;top:' + e + 'px'),
        ...
        B = function (e, i) {
          ...
          if (t.type == 'text') {
            ...
            ((t.W = m.w = ($.right - $.left) / Y),
              ...
              (t.Y = m.y + t.H / 2),
              ('x' in i || 'y' in i) &&
                (t.path.v = a.format('m{0},{1}l{2},{1}', f(m.x * u), f(m.y * u), f(m.x * u) + 1)));
            var _ = [
              'x',
              'y',
              'text',
              ...
              ((l = 'radial'),
                b &&
                  ...
                  i(b - 0.5, 2) + i(c - 0.5, 2) > 0.25 &&
                    (c = e.sqrt(0.25 - i(b - 0.5, 2)) * ((c > 0.5) * 2 - 1) + 0.5),
                  (m = b + n + c)));
              return o;
            })),
            (f = f.split(/\s*\-\s*/)));
