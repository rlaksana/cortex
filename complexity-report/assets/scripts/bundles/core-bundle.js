(!(function (a, b) {
  ...
  function w(a) {
    ...
    return (
      b.remove(),
      ('none' === c || '' === c) &&
        ((dc = P.body.appendChild(
          dc || $.extend(P.createElement('iframe'), { frameBorder: 0, width: 0, height: 0 })
        )),
        (ec && dc.createElement) ||
  ...
  function z(a, c, d, e, f, g) {
    ...
    for (var h, i = a[f], j = 0, k = i ? i.length : 0, l = a === Kc; k > j && (l || !h); j++)
      ((h = i[j](c, d, e)),
        'string' == typeof h &&
          (!l || g[h] ? (h = b) : (c.dataTypes.unshift(h), (h = z(a, c, d, e, h, g)))));
    ...
    if ((g = p.length)) {
      ...
      for (d = 0; g > d; d++)
        ((e = p[d]),
          ...
          e in h ||
            ((h[e] = j.start),
            q && ((j.end = j.start), (j.start = 'width' === e || 'height' === e ? 1 : 0))));
    }
  }
      ...
      if ($.acceptData(a)) {
        ...
        if (i[j]) {
          if (b && (d = c ? i[j] : i[j].data)) {
            $.isArray(b) ||
              (b in d ? (b = [b]) : ((b = $.camelCase(b)), (b = b in d ? [b] : b.split(' '))));
        ...
        : this.each(function () {
            if ('string' === c)
              ...
              ('undefined' === c || 'boolean' === c) &&
                ...
                (this.className =
                  this.className || a === !1 ? '' : $._data(this, '__className__') || ''));
          });
    },
    hasClass: function (a) {
    ...
    (sb = {
      get: function (a, c) {
        var d,
          e = $.prop(a, c);
        return e === !0 ||
          ('boolean' != typeof e && (d = a.getAttributeNode(c)) && d.nodeValue !== !1)
          ? c.toLowerCase()
          : b;
      },
      set: function (a, b, c) {
    ...
    trigger: function (c, d, e, f) {
      if (!e || (3 !== e.nodeType && 8 !== e.nodeType)) {
        ...
        if (((o = [[e, m.bindType || q]]), !f && !m.noBubble && !$.isWindow(e))) {
          for (
            p = m.delegateType || q, j = Gb.test(p + q) ? e : e.parentNode, k = e;
            j;
            j = j.parentNode
          )
            (o.push([j, p]), (k = j));
          ...
          for (
            ...
            ((k = i.matches[e]),
              (p ||
                ...
                g !== b &&
                  ((c.result = g), g === !1 && (c.preventDefault(), c.stopPropagation()))));
      ...
      on: function (a, c, d, e, g) {
        ...
        if (
          (null == d && null == e
            ? ((e = c), (d = c = b))
            : null == e &&
              ('string' == typeof c ? ((e = d), (d = b)) : ((e = d), (d = c), (c = b))),
          e === !1)
        )
          e = f;
    ...
    (function (a, b) {
      ...
      var r,
        ...
        nb = ib(function (a) {
          ...
          var b =
            F.getElementsByName &&
            F.getElementsByName(D).length === 2 + F.getElementsByName(D + 0).length;
              ...
              ID: s
                ...
                : function (a, c, d) {
                    if (typeof c.getElementById !== C && !d) {
                      ...
                      return e
                        ? e.id === a ||
                          (typeof e.getAttributeNode !== C && e.getAttributeNode('id').value === a)
                          ? [e]
                          : b
                        : [];
                    }
            ...
            (ib(function (a) {
              ((a.innerHTML = "<select><option selected=''></option></select>"),
                a.querySelectorAll('[selected]').length ||
                  f.push(
                    '\\[' + S + '*(?:checked|disabled|ismap|multiple|readonly|selected|value)'
                  ),
    ...
    closest: function (a, b) {
      for (
        var c,
          ...
          e = this.length,
          f = [],
          g = Lb.test(a) || 'string' != typeof a ? $(a, b || this.context) : 0;
        e > d;
        d++
      )
  ...
  ((_b.optgroup = _b.option),
            ...
            if (
              ...
              try {
                for (; e > d; d++)
                  ((c = this[d] || {}),
                    1 === c.nodeType &&
                      ($.cleanData(c.getElementsByTagName('*')), (c.innerHTML = a)));
                c = 0;
              } catch (f) {}
            }
    ...
    ($.buildFragment = function (a, c, d) {
      ...
      return (
        ...
        e ||
          ((e = c.createDocumentFragment()), $.clean(a, c, e, d), f && ($.fragments[h] = g && e)),
    ...
    $.extend({
      ...
      clean: function (a, b, c, d) {
        var e,
          ...
          s = [];
        for (
          (b && 'undefined' != typeof b.createDocumentFragment) || (b = P), e = 0;
          null != (g = a[e]);
          e++
        )
      ...
      style: function (a, c, d, e) {
        if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
          ...
          if (
            ...
            'string' === g &&
              (f = mc.exec(d)) &&
              ((d = (f[1] + 1) * f[2] + parseFloat($.css(a, c))), (g = 'number')),
            !(
              null == d ||
              ('number' === g && isNaN(d)) ||
      ...
      $.cssHooks[b] = {
        ...
        set: function (a, c, d) {
          return t(
            a,
            c,
            d ? u(a, b, d, $.support.boxSizing && 'border-box' === $.css(a, 'boxSizing')) : 0
          );
        },
      };
    }),
      ...
      (($.expr.filters.hidden = function (a) {
        return (
          ...
          (!$.support.reliableHiddenOffsets &&
            'none' === ((a.style && a.style.display) || cc(a, 'display')))
        );
      }),
      ...
      return this.map(function () {
        ...
        .filter(function () {
          return (
            this.name &&
            !this.disabled &&
            (this.checked || xc.test(this.nodeName) || wc.test(this.type))
          );
        })
        .map(function (a, b) {
          var c = $(this).val();
    ...
    $.extend({
      ...
      ajax: function (a, c) {
        ...
        if (
          ...
          !m.hasContent &&
            (m.data && ((m.url += (Fc.test(m.url) ? '&' : '?') + m.data), delete m.data),
            (e = m.url),
            m.cache === !1))
        ) {
          var x = $.now(),
  ...
  ($.ajaxSetup({
    ...
    $.ajaxPrefilter('json jsonp', function (c, d, e) {
      ...
      return 'jsonp' === c.dataTypes[0] || l || m
        ? ((f = c.jsonpCallback =
            $.isFunction(c.jsonpCallback) ? c.jsonpCallback() : c.jsonpCallback),
          (g = a[f]),
          l
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            ...
            a && !ad.test(a.nodeName) && 'static' === $.css(a, 'position');
  ...
  (function (a, b) {
    function c(a) {
      return a && 'object' == typeof a && a.__wrapped__
        ? a
        : this instanceof c
          ? ((this.__wrapped__ = a), void 0)
          : new c(a);
    }
    function d(a, b, c) {
      b || (b = 0);
    ...
    function g(a, b, c) {
      function d() {
        ...
        return (
          e || (a = b[g]),
          c.length && (h = h.length ? c.concat(n(h)) : c),
          this instanceof d
    ...
    function i() {
      for (
        var a, b = { b: '', c: '', e: Z, f: Ub, g: '', h: Wb, i: Zb, j: sb, k: '', l: !0 }, c = 0;
        (a = arguments[c]);
        c++
      )
      ...
      if (
        ...
        (b.d = /^[^,]+/.exec(a)[0]),
        (c = Function),
        (d = 'var i,l=' + b.d + ',t=' + b.d + ';if(!' + b.d + ')return t;' + b.k + ';'),
        b.b
          ? ((d += "var m=l.length;i=-1;if(typeof m=='number'){"),
            b.i && (d += "if(k(l)){l=l.split('')}"),
            (d += 'while(++i<m){' + b.b + '}}else {'))
          : b.h && (d += "var m=l.length;i=-1;if(m&&j(l)){while(++i<m){i+='';" + b.g + '}}else {'),
        b.e || (d += "var u=typeof l=='function'&&s.call(l,'prototype');"),
        b.f && b.l
          ? ((d += 'var q=-1,r=p[typeof l]?n(l):[],m=r.length;while(++q<m){i=r[q];'),
            b.e || (d += "if(!(u&&i=='prototype')){"),
            (d += b.g + ''),
            b.e || (d += '}'))
          : ((d += 'for(i in l){'),
            (!b.e || b.l) &&
        ...
        for (var e = 0; 7 > e; e++)
          ((d += "i='" + b.j[e] + "';if("),
            'constructor' == b.j[e] && (d += '!(f&&f.prototype===l)&&'),
            (d += 'h.call(l,i)){' + b.g + '}'));
      }
      return (
        (b.b || b.h) && (d += '}'),
        (d += b.c + ';return t'),
        c('e,h,j,k,p,n,s', 'return function(' + a + '){' + d + '}')(h, xb, p, z, cc, Fb, zb)
      );
    }
    function j(a) {
      return '\\' + dc[a];
    ...
    function q(a) {
      var b = !1;
      if (!a || 'object' != typeof a || p(a)) return b;
      var c = a.constructor;
      return (!w(c) && (!$b || !l(a))) || c instanceof c
        ? $
          ? (jc(a, function (a, c, d) {
    ...
    function s(a, b, c, d, e) {
      ...
      if ((c && (b = !1), (c = x(a)))) {
        var f = Ab.call(a);
        if (!ac[f] || ($b && l(a))) return a;
        var g = oc(a);
      }
      if (!c || !b) return c ? (g ? n(a) : ic({}, a)) : a;
      switch (((c = bc[f]), f)) {
        case Lb:
        case Mb:
          return new c(+a);
      ...
      return (
        d.push(a),
        e.push(h),
        (g ? G : kc)(a, function (a, c) {
          h[c] = s(a, b, null, d, e);
        }),
        g &&
          (xb.call(a, 'index') && (h.index = a.index), xb.call(a, 'input') && (h.input = a.input)),
        h
      );
    }
    function t(a) {
    ...
    function v(a, b, c, d) {
      ...
      var e = Ab.call(a),
        f = Ab.call(b);
      if ((e == Jb && (e = Ob), f == Jb && (f = Ob), e != f)) return !1;
      switch (e) {
        case Lb:
        case Mb:
          return +a == +b;
      ...
      if (((f = e == Kb), !f)) {
        if (a.__wrapped__ || b.__wrapped__) return v(a.__wrapped__ || a, b.__wrapped__ || b);
        if (e != Ob || ($b && (l(a) || l(b)))) return !1;
        var e = !Xb && p(a) ? Object : a.constructor,
          g = !Xb && p(b) ? Object : b.constructor;
        if (!(e == g || (w(e) && e instanceof e && w(g) && g instanceof g))) return !1;
      }
      for (c || (c = []), d || (d = []), e = c.length; e--; ) if (c[e] == a) return d[e] == b;
      var h = !0,
        i = 0;
      if ((c.push(a), d.push(b), f)) {
        if (((i = a.length), (h = i == b.length))) for (; i-- && (h = v(a[i], b[i], c, d)); );
        return h;
      }
      return (
        jc(a, function (a, e, f) {
        ...
        kc(d[e], function (b, c) {
          ...
          if (b && ((e = oc(b)) || pc(b))) {
            ...
            d
              ? (a[c] = h[i])
              : (g.push(b),
                h.push(((f = a[c]), (f = e ? (oc(f) ? f : []) : pc(f) ? f : {}))),
                (a[c] = A(f, b, cb, g, h)));
          } else null != b && (a[c] = b);
        });
      return a;
    ...
    function D(a, b, c) {
      var d = !0,
        b = h(b, c);
      if (oc(a)) for (var c = -1, e = a.length; ++c < e && (d = !!b(a[c], c, a)); );
      else
        hc(a, function (a, c, e) {
          return (d = !!b(a, c, e));
        });
    ...
    function P(a, b, c) {
      var d = -1,
        e = a ? a.length : 0;
      if ('number' == typeof c) d = (0 > c ? Gb(0, e + c) : c || 0) - 1;
      else if (c) return ((d = R(a, b)), a[d] === b ? d : -1);
    ...
    function R(a, b, c, d) {
      for (var e = 0, f = a ? a.length : e, c = c ? h(c, d) : U, b = c(b); f > e; )
    ...
    function T(a, b) {
      return Tb || (Bb && 2 < arguments.length)
        ? Bb.call.apply(Bb, arguments)
        : g(a, b, n(arguments, 2));
    }
    function U(a) {
      return a;
    ...
    var Z,
      ...
      Tb = Bb && !Sb,
      Ub = Fb && (Rb || Sb),
      Vb = ((Vb = { 0: 1, length: 1 }), _.splice.call(Vb, 0, 1), Vb[0]),
      Wb = !0;
    !(function () {
      function a() {
        this.x = 1;
    ...
    ((bc[Kb] = Array),
      ...
      (bc[Pb] = RegExp),
      (bc[Qb] = String));
    var cc = { boolean: !1, function: !0, object: !0, number: !1, string: !1, undefined: !1 },
      dc = {
        '\\': '\\',
        "'": "'",
        '\n': 'n',
    ...
    ((c.after = function (a, b) {
      ...
      (c.bindAll = function (a) {
        for (var b = arguments, c = 1 < b.length ? 0 : ((b = t(a)), -1), d = b.length; ++c < d; ) {
          var e = b[c];
          a[e] = T(a[e], a);
        }
        return a;
      ...
      (c.difference = function (a) {
        for (
          var b = -1, c = a ? a.length : 0, e = ub.apply(_, arguments), e = d(e, c), f = [];
          ++b < c;
      ...
      (c.intersection = function (a) {
        ...
        a: for (; ++f < g; ) {
          ...
          if (l || 0 > P(j, k)) {
            h && j.push(k);
            for (var m = c; --m; ) if (!(e[m] || (e[m] = d(b[m], 0, 100)))(k)) continue a;
            i.push(k);
          }
        }
        return i;
      ...
      (c.omit = function (a, b, c) {
        var d = 'function' == typeof b,
          e = {};
        if (d) b = h(b, c);
        else var f = ub.apply(_, arguments);
        return (
          jc(a, function (a, c, g) {
      ...
      (c.pick = function (a, b, c) {
        ...
        if ('function' != typeof b)
          for (var e = 0, f = ub.apply(_, arguments), g = f.length; ++e < g; ) {
            var i = f[e];
            i in a && (d[i] = a[i]);
          }
        else
      ...
      (c.range = function (a, b, c) {
        ...
        for (var d = -1, b = Gb(0, tb((b - a) / c)), e = Array(b); ++d < b; )
          ((e[d] = a), (a += c));
        return e;
      }),
      ...
      (c.throttle = function (a, b) {
        ...
        return function () {
          ...
          return (
            ...
            (f = this),
            0 >= j
              ? (clearTimeout(g), (g = null), (h = i), (e = a.apply(f, d)))
              : g || (g = setTimeout(c, j)),
            e
          );
        };
      ...
      (c.without = function (a) {
        for (var b = -1, c = a ? a.length : 0, e = d(arguments, 1, 20), f = []; ++b < c; ) {
          var g = a[b];
          e(g) || f.push(g);
        }
        return f;
      ...
      (c.zip = function (a) {
        for (var b = -1, c = a ? I(J(arguments, 'length')) : 0, d = Array(c); ++b < c; )
          d[b] = J(arguments, b);
        return d;
      }),
      (c.collect = H),
      ...
      (c.isEmpty = function (a) {
        ...
        return c == Kb ||
          ...
          c == Jb ||
          (Yb && p(a)) ||
          (c == Ob && 'number' == typeof d && w(a.splice))
          ? !d
          : (kc(a, function () {
              return (b = !1);
            }),
      ...
      (c.template = function (a, b, d) {
        ...
        (a.replace(
          RegExp(
            (d.escape || g.escape || pb).source +
              '|' +
              i.source +
              '|' +
              (i === ob ? nb : pb).source +
              '|' +
              (d.evaluate || g.evaluate || pb).source +
              '|$',
            'g'
          ),
          function (b, c, d, f, g, i) {
            return (
              d || (d = f),
              (k += a.slice(h, i).replace(rb, j)),
              c && (k += "'+__e(" + c + ")+'"),
              g && (k += "';" + g + ";__p+='"),
              d && (k += "'+((__t=(" + d + "))==null?'':__t)+'"),
              e || (e = g || fb.test(c || d)),
          ...
          m ||
            ...
            e
              ? (k = 'with(' + l + '){' + k + '}')
              : ((d = RegExp('(\\(\\s*)' + l + '\\.' + l + '\\b', 'g')),
                (k = k.replace(lb, '$&' + l + '.').replace(d, '$1__d')))),
          (k = (e ? k.replace(hb, '') : k).replace(ib, '$1').replace(jb, '$1;')),
          (k =
            'function(' +
            l +
            '){' +
      ...
      (c.prototype.value = W),
      (c.prototype.valueOf = W),
      hc(['join', 'pop', 'shift'], function (a) {
        var b = _[a];
      ...
      Vb &&
        hc(['pop', 'shift', 'splice'], function (a) {
          var b = _[a],
            d = 'splice' == a;
          c.prototype[a] = function () {
            var a = this.__wrapped__,
      ...
      'function' == typeof define && 'object' == typeof define.amd && define.amd
        ...
        : X
          ? 'object' == typeof module && module && module.exports == X
            ? ((module.exports = c)._ = c)
            : (X._ = c)
          : (a._ = c));
  })(this),
  (function (a) {
        ...
        function (a, b) {
          ...
          for (i = 0, k = n.length; k > i; i++)
            for (l = 0; l < o.length; l += h.length - 2) {
              if (((h = [l, 1]), (c = o[l].n), n[i] != g)) c[n[i]] && h.push(c[n[i]]);
  ...
  (function () {
    ...
    function b(a, b, c, e, g, h) {
      ...
      if (i) {
        if (j) ((j.initstatus = e), (j.start = new Date() - j.ms * e));
        else {
          for (var y in i)
            if (i[x](y) && (bb[x](y) || b.paper.customAttributes[x](y)))
              switch (((p[y] = b.attr(y)), null == p[y] && (p[y] = ab[y]), (q[y] = i[y]), bb[y])) {
                ...
                case 'colour':
                  p[y] = r.getRGB(p[y]);
                  var z = r.getRGB(q[y]);
                  s[y] = { r: (z.r - p[y].r) / o, g: (z.g - p[y].g) / o, b: (z.b - p[y].b) / o };
                  break;
                case 'path':
                  var A = Ib(p[y], q[y]),
                    B = A[1];
                  for (p[y] = A[0], s[y] = [], v = 0, w = p[y].length; w > v; v++) {
                    s[y][v] = [0];
                    for (var D = 1, E = p[y][v].length; E > D; D++)
                ...
                case 'transform':
                  ...
                  if (I)
                    for (
                      p[y] = I.from, q[y] = I.to, s[y] = [], s[y].real = !0, v = 0, w = p[y].length;
                      w > v;
                      v++
                    )
                ...
                case 'csv':
                  var L = G(i[y])[H](u),
                    M = G(p[y])[H](u);
                  if ('clip-rect' == y)
                    for (p[y] = M, s[y] = [], v = M.length; v--; ) s[y][v] = (L[v] - p[y][v]) / o;
                  q[y] = L;
                  break;
                default:
                  for (
                    L = [][C](i[y]),
                      M = [][C](p[y]),
                      s[y] = [],
                      v = b.paper.customAttributes[y].length;
                    v--;
          ...
          if (
            ...
            fc.push(t),
            e && !j && !k && ((t.stop = !0), (t.start = new Date() - o * e), 1 == fc.length))
          )
            return hc();
    ...
    function c(a, b) {
      ...
      if (((this.ms = b), (this.times = 1), a)) {
        for (var e in a) a[x](e) && ((d[Z(e)] = a[e]), c.push(Z(e)));
        c.sort(jb);
      }
    ...
    function d(a, b, c, d, e, f) {
      function g(a, b) {
        var c, d, e, f, g, h;
        for (e = a, h = 0; 8 > h; h++) {
          if (((f = i(e) - a), O(f) < b)) return e;
          if (((g = (3 * l * e + 2 * k) * e + j), O(g) < 1e-6)) break;
          e -= f / g;
        }
        if (((c = 0), (d = 1), (e = a), c > e)) return c;
        if (e > d) return d;
        for (; d > c; ) {
          if (((f = i(e)), O(f - a) < b)) return e;
    ...
    function g(a, b, c) {
      ...
      for (var d, e, f, g, i, j, k, l, m, n, o = c ? 0 : [], p = 0, q = a.length; q > p; p++) {
        var s = a[p];
        if ('M' == s[0]) ((d = i = s[1]), (e = j = s[2]));
        else {
          'C' == s[0]
            ? ((m = [d, e].concat(s.slice(1))), (d = m[6]), (e = m[7]))
            : ((m = [d, e, d, e, i, j, i, j]), (d = i), (e = j));
          for (var t = 0, u = b.length; u > t; t++) {
            var v = b[t];
            if ('M' == v[0]) ((f = k = v[1]), (g = l = v[2]));
            else {
              'C' == v[0]
                ? ((n = [f, g].concat(v.slice(1))), (f = n[6]), (g = n[7]))
                : ((n = [f, g, f, g, k, l, k, l]), (f = k), (g = l));
              var w = h(m, n, c);
              if (c) o += w;
              else {
    ...
    function h(a, b, c) {
      var d = r.bezierBBox(a),
        e = r.bezierBBox(b);
      if (!r.isBBoxIntersect(d, e)) return c ? 0 : [];
      for (
        var f = k.apply(0, a),
          g = k.apply(0, b),
          h = ~~(f / 5),
        ...
        l.push({ x: q.x, y: q.y, t: p / h });
      }
      for (p = 0; j + 1 > p; p++)
        ((q = r.findDotsAtSegment.apply(r, b.concat(p / j))), m.push({ x: q.x, y: q.y, t: p / j }));
      for (p = 0; h > p; p++)
        for (var s = 0; j > s; s++) {
          var t = l[p],
            u = l[p + 1],
            v = m[s],
            w = m[s + 1],
            x = O(u.x - t.x) < 0.001 ? 'y' : 'x',
            y = O(w.x - v.x) < 0.001 ? 'y' : 'x',
            z = i(t.x, t.y, u.x, u.y, v.x, v.y, w.x, w.y);
          if (z) {
            if (n[z.x.toFixed(4)] == z.y.toFixed(4)) continue;
            ...
            A >= 0 &&
              ...
              B >= 0 &&
              1 >= B &&
              (c ? o++ : o.push({ x: z.x, y: z.y, t1: A, t2: B }));
          }
        }
      return o;
    }
    ...
    function q(a) {
      ...
      for (var c in a) a[x](c) && (b[c] = q(a[c]));
      return b;
    }
    function r(a) {
      if (r.is(a, 'function')) return s ? a() : eve.on('raphael.DOMload', a);
      if (r.is(a, T)) return r._engine.create[B](r, a.splice(0, 3 + r.is(a[0], R))).add(a);
    ...
    var s,
      t,
      u = /[, ]+/,
      v = { circle: 1, rect: 1, path: 1, ellipse: 1, text: 1, image: 1 },
      w = /\{(\d+)\}/g,
      x = 'hasOwnProperty',
      y = { doc: document, win: window },
      z = { was: Object.prototype[x].call(y.win, 'Raphael'), is: y.win.Raphael },
      A = function () {
    ...
    if (
      ...
      (r.type =
        y.win.SVGAngle ||
        y.doc.implementation.hasFeature('http://www.w3.org/TR/SVG11/feature#BasicStructure', '1.1')
          ? 'SVG'
          : 'VML'),
      'VML' == r.type)
    ) {
      ...
      if (
        ((rb.innerHTML = '<v:shape adj="1"/>'),
        (qb = rb.firstChild),
        (qb.style.behavior = 'url(#default#VML)'),
        !qb || 'object' != typeof qb.adj)
      )
        return (r.type = E);
      rb = null;
    }
    ((r.svg = !(r.vml = 'VML' == r.type)),
      (r._Paper = A),
      (r.fn = t = A.prototype = r.prototype),
      (r._id = 0),
      (r._oid = 0),
      (r.is = function (a, b) {
        return (
      ...
      (r.snapTo = function (a, b, c) {
        if (((c = r.is(c, 'finite') ? c : 10), r.is(a, T))) {
          for (var d = a.length; d--; ) if (O(a[d] - b) <= c) return a[d];
        } else {
          a = +a;
          var e = b % a;
          if (c > e) return b - e;
    ...
    r.setWindow = function (a) {
      (eve('raphael.setWindow', r, y.win, a),
        (y.win = a),
        (y.doc = y.win.document),
        r._engine.initWin && r._engine.initWin(y.win));
    };
    var sb = function (a) {
        if (r.vml) {
          var b,
          ...
          ((g.title = 'Raphaël Colour Picker'),
            ...
            y.doc.body.appendChild(g),
            (sb = o(function (a) {
              return (
                (g.style.color = a),
                y.doc.defaultView.getComputedStyle(g, E).getPropertyValue('color')
              );
            })));
        }
        return sb(a);
      ...
      xb = function (a, b, c, d) {
        ((a *= 255), (b *= 255), (c *= 255));
        var e = { r: a, g: b, b: c, hex: r.rgb(a, b, c), toString: vb };
        return (r.is(d, 'finite') && (e.opacity = d), e);
      };
    ((r.color = function (a) {
      var b;
      return (
        r.is(a, 'object') && 'h' in a && 's' in a && 'b' in a
          ? ((b = r.hsb2rgb(a)), (a.r = b.r), (a.g = b.g), (a.b = b.b), (a.hex = b.hex))
          : r.is(a, 'object') && 'h' in a && 's' in a && 'l' in a
            ? ((b = r.hsl2rgb(a)), (a.r = b.r), (a.g = b.g), (a.b = b.b), (a.hex = b.hex))
            : (r.is(a, 'string') && (a = r.getRGB(a)),
              r.is(a, 'object') && 'r' in a && 'g' in a && 'b' in a
                ? ((b = r.rgb2hsl(a)),
                  (a.h = b.h),
                  (a.s = b.s),
                  (a.l = b.l),
    ...
    ((r.getRGB = o(function (a) {
      ...
      if ('none' == a) return { r: -1, g: -1, b: -1, hex: 'none', toString: n };
      ...
      return h
        ? (h[2] &&
            ((d = $(h[2].substring(5), 16)),
            (c = $(h[2].substring(3, 5), 16)),
            (b = $(h[2].substring(1, 3), 16))),
          h[3] &&
            ((d = $((f = h[3].charAt(3)) + f, 16)),
            (c = $((f = h[3].charAt(2)) + f, 16)),
            (b = $((f = h[3].charAt(1)) + f, 16))),
          h[4] &&
            ((g = h[4][H](cb)),
            (b = Z(g[0])),
            '%' == g[0].slice(-1) && (b *= 2.55),
            ...
            (d = Z(g[2])),
            '%' == g[2].slice(-1) && (d *= 2.55),
            'rgba' == h[1].toLowerCase().slice(0, 4) && (e = Z(g[3])),
            g[3] && '%' == g[3].slice(-1) && (e /= 100)),
          h[5]
            ? ((g = h[5][H](cb)),
              (b = Z(g[0])),
              '%' == g[0].slice(-1) && (b *= 2.55),
              ...
              (d = Z(g[2])),
              '%' == g[2].slice(-1) && (d *= 2.55),
              ('deg' == g[0].slice(-3) || '°' == g[0].slice(-1)) && (b /= 360),
              'hsba' == h[1].toLowerCase().slice(0, 4) && (e = Z(g[3])),
              g[3] && '%' == g[3].slice(-1) && (e /= 100),
              r.hsb2rgb(b, c, d, e))
            : h[6]
              ? ((g = h[6][H](cb)),
                ...
                '%' == g[2].slice(-1) && (d *= 2.55),
                ('deg' == g[0].slice(-3) || '°' == g[0].slice(-1)) && (b /= 360),
                'hsla' == h[1].toLowerCase().slice(0, 4) && (e = Z(g[3])),
                g[3] && '%' == g[3].slice(-1) && (e /= 100),
                r.hsl2rgb(b, c, d, e))
              : ((h = { r: b, g: c, b: d, toString: n }),
                (h.hex = '#' + (16777216 | d | (c << 8) | (b << 16)).toString(16).slice(1)),
                r.is(e, 'finite') && (h.opacity = e),
                h))
        : { r: -1, g: -1, b: -1, hex: 'none', error: 1, toString: n };
    }, r)),
      (r.hsb = o(function (a, b, c) {
      ...
      (r.getColor = function (a) {
        ...
        return (
          (b.h += 0.075),
          b.h > 1 &&
            ((b.h = 0), (b.s -= 0.2), b.s <= 0 && (this.getColor.start = { h: 0, s: 1, b: b.b })),
          c.hex
        );
      }),
      ...
      (r.parsePathString = function (a) {
        if (!a) return null;
        var b = yb(a);
        if (b.arr) return Ab(b.arr);
        var c = { a: 7, c: 6, h: 1, l: 2, m: 2, r: 4, q: 4, s: 4, t: 2, v: 1, z: 0 },
          d = [];
        return (
          r.is(a, T) && r.is(a[0], T) && (d = Ab(a)),
          d.length ||
            G(a).replace(fb, function (a, b, e) {
              var f = [],
                g = b.toLowerCase();
              if (
                (e.replace(hb, function (a, b) {
                  b && f.push(+b);
                }),
                'm' == g &&
                  f.length > 2 &&
                  (d.push([b][C](f.splice(0, 2))), (g = 'l'), (b = 'm' == b ? 'l' : 'L')),
                'r' == g)
              )
                d.push([b][C](f));
              else for (; f.length >= c[g] && (d.push([b][C](f.splice(0, c[g]))), c[g]); );
            }),
          (d.toString = r._path2string),
          (b.arr = Ab(d)),
          d
        );
      }),
      (r.parseTransformString = o(function (a) {
        ...
        var b = [];
        return (
          r.is(a, T) && r.is(a[0], T) && (b = Ab(a)),
          b.length ||
            G(a).replace(gb, function (a, c, d) {
              {
                var e = [];
                K.call(c);
              }
              (d.replace(hb, function (a, b) {
                b && e.push(+b);
              }),
                b.push([c][C](e)));
            }),
          (b.toString = r._path2string),
          b
        );
      })));
    var yb = function (a) {
    ...
    var zb = (r.pathBBox = function (a) {
        ...
        a = Ib(a);
        for (var c, d = 0, e = 0, f = [], g = [], h = 0, i = a.length; i > h; h++)
          if (((c = a[h]), 'M' == c[0])) ((d = c[1]), (e = c[2]), f.push(d), g.push(e));
          else {
        ...
        var k = N[B](0, f),
          ...
          m = M[B](0, f),
          n = M[B](0, g),
          o = { x: k, y: l, x2: m, y2: n, width: m - k, height: n - l };
        return ((b.bbox = q(o)), o);
      }),
      Ab = function (a) {
        var b = q(a);
      ...
      Bb = (r._pathToRelative = function (a) {
        ...
        var c = [],
          ...
          h = 0;
        'M' == a[0][0] &&
          ((d = a[0][1]), (e = a[0][2]), (f = d), (g = e), h++, c.push(['M', d, e]));
        for (var i = h, j = a.length; j > i; i++) {
          var k = (c[i] = []),
            l = a[i];
          if (l[0] != K.call(l[0]))
            switch (((k[0] = K.call(l[0])), k[0])) {
              ...
              case 'm':
                ((f = l[1]), (g = l[2]));
              default:
                for (var m = 1, n = l.length; n > m; m++)
                  k[m] = +(l[m] - (m % 2 ? d : e)).toFixed(3);
            }
          else {
            ((k = c[i] = []), 'm' == l[0] && ((f = l[1] + d), (g = l[2] + e)));
            for (var o = 0, p = l.length; p > o; o++) c[i][o] = l[o];
          }
          var q = c[i].length;
          switch (c[i][0]) {
            case 'z':
      ...
      Cb = (r._pathToAbsolute = function (a) {
        ...
        var c = [],
          ...
          h = 0;
        'M' == a[0][0] &&
          ((d = +a[0][1]), (e = +a[0][2]), (f = d), (g = e), h++, (c[0] = ['M', d, e]));
        for (
          var i,
            j,
            k =
          ...
          if ((c.push((i = [])), (j = a[l]), j[0] != _.call(j[0])))
            switch (((i[0] = _.call(j[0])), i[0])) {
              ...
              case 'H':
                ...
                break;
              case 'R':
                for (var o = [d, e][C](j.slice(1)), p = 2, q = o.length; q > p; p++)
                  ((o[p] = +o[p] + d), (o[++p] = +o[p] + e));
                (c.pop(), (c = c[C](m(o, k))));
                break;
              case 'M':
                ((f = +j[1] + d), (g = +j[2] + e));
              default:
                for (p = 1, q = j.length; q > p; p++) i[p] = +j[p] + (p % 2 ? d : e);
            }
          else if ('R' == j[0])
            ((o = [d, e][C](j.slice(1))),
              c.pop(),
              (c = c[C](m(o, k))),
              (i = ['R'][C](j.slice(-2))));
          else for (var s = 0, t = j.length; t > s; s++) i[s] = j[s];
          switch (i[0]) {
            case 'Z':
              ((d = f), (e = g));
              break;
      ...
      Fb = function (a, b, c, d, e, f, g, h, i, j) {
        ...
        if (j) ((y = j[0]), (z = j[1]), (w = j[2]), (x = j[3]));
          ...
          var t = c * c,
            ...
            v =
              (f == g ? -1 : 1) *
              L.sqrt(O((t * u - t * r * r - u * q * q) / (t * r * r + u * q * q))),
            w = (v * c * r) / d + (a + h) / 2,
            x = (v * -d * q) / c + (b + i) / 2,
        ...
        if (O(A) > l) {
          ...
          ((z = y + l * (g && z > y ? 1 : -1)),
            (h = w + c * L.cos(z)),
            (i = x + d * L.sin(z)),
            (n = Fb(h, i, c, d, e, 0, g, D, E, [z, B, w, x])));
        }
        A = z - y;
        var F = L.cos(y),
          G = L.sin(y),
          ...
          S = [h + M * J, i - N * I],
          T = [h, i];
        if (((R[0] = 2 * P[0] - R[0]), (R[1] = 2 * P[1] - R[1]), j)) return [R, S, T][C](n);
        n = [R, S, T][C](n).join()[H](',');
      ...
      Hb = o(function (a, b, c, d, e, f, g, h) {
        ...
        return (
          ...
          m > 0 && 1 > m && ((i = Gb(a, b, c, d, e, f, g, h, m)), p.push(i.x), o.push(i.y)),
          n > 0 && 1 > n && ((i = Gb(a, b, c, d, e, f, g, h, n)), p.push(i.x), o.push(i.y)),
          { min: { x: N[B](0, p), y: N[B](0, o) }, max: { x: M[B](0, p), y: M[B](0, o) } }
        );
      }),
      Ib = (r._path2curve = o(
        function (a, b) {
      ...
      Jb =
        ((r._parseDots = o(function (a) {
          for (var b = [], c = 0, d = a.length; d > c; c++) {
            var e = {},
              f = a[c].match(/^([^:]*):?([\d\.]*)/);
            if (((e.color = r.getRGB(f[1])), e.color.error)) return null;
            ((e.color = e.color.hex), f[2] && (e.offset = f[2] + '%'), b.push(e));
          }
          for (c = 1, d = b.length - 1; d > c; c++)
            if (!b[c].offset) {
              for (var g = Z(b[c - 1].offset || 0), h = 0, i = c + 1; d > i; i++)
                if (b[i].offset) {
                  h = b[i].offset;
                  break;
                }
              (h || ((h = 100), (i = d)), (h = Z(h)));
              for (var j = (h - g) / (i - c + 1); i > c; c++) ((g += j), (b[c].offset = g + '%'));
            }
          return b;
        })),
      ...
      Kb =
        ((r._tofront = function (a, b) {
          b.top !== a &&
            (Jb(a, b), (a.next = null), (a.prev = b.top), (b.top.next = a), (b.top = a));
        }),
        (r._toback = function (a, b) {
          b.bottom !== a &&
            (Jb(a, b), (a.next = b.bottom), (a.prev = null), (b.bottom.prev = a), (b.bottom = a));
        }),
              ...
              ('t' == v && 3 == u
                ...
                : 'r' == v
                  ? 2 == u
                    ...
                    : 4 == u &&
                      (w
                        ? ((p = x.x(t[2], t[3])), (q = x.y(t[2], t[3])), k.rotate(t[1], p, q))
      ...
      Nb = (r._equaliseTransform = function (a, b) {
        ((b = G(b).replace(/\.{3}|\u2026/g, a)),
          (a = r.parseTransformString(a) || []),
          (b = r.parseTransformString(b) || []));
        for (var c, d, e, f, g = M(a.length, b.length), h = [], i = [], j = 0; g > j; j++) {
          if (
            ((e = a[j] || Mb(b[j])),
            (f = b[j] || Mb(e)),
            e[0] != f[0] ||
              ('r' == e[0].toLowerCase() && (e[2] != f[2] || e[3] != f[3])) ||
              ('s' == e[0].toLowerCase() && (e[3] != f[3] || e[4] != f[4])))
          )
            return;
    ...
    ((r._getContainer = function (a, b, c, d) {
      var e;
      return (
        (e = null != d || r.is(a, 'object') ? a : y.doc.getElementById(a)),
        null != e
          ? e.tagName
            ? null == b
              ? {
              ...
              : { container: e, width: b, height: c }
            : { container: 1, x: a, y: b, width: c, height: d }
          : void 0
      );
    }),
      (r.pathToRelative = Bb),
      ...
      (function (a) {
        ...
        ((a.add = function (a, b, c, d, e, g) {
          ...
          (a.split = function () {
            ...
            return (
              0 > f
                ? ((a.rotate = r.deg(L.acos(f))), 0 > e && (a.rotate = 360 - a.rotate))
                : (a.rotate = r.deg(L.asin(e))),
              (a.isSimple = !(
                +a.shear.toFixed(9) ||
                (a.scalex.toFixed(9) != a.scaley.toFixed(9) && a.rotate)
              )),
              (a.isSuperSimple =
                !+a.shear.toFixed(9) && a.scalex.toFixed(9) == a.scaley.toFixed(9) && !a.rotate),
          ...
          (a.toTransformString = function (a) {
            ...
            return b.isSimple
              ? ((b.scalex = +b.scalex.toFixed(4)),
                ...
                (b.dx || b.dy ? 't' + [b.dx, b.dy] : E) +
                  (1 != b.scalex || 1 != b.scaley ? 's' + [b.scalex, b.scaley, 0, 0] : E) +
                  (b.rotate ? 'r' + [b.rotate, 0, 0] : E))
              : 'm' +
    ...
    t.safari =
      ('Apple Computer, Inc.' == navigator.vendor &&
        ((Ob && Ob[1] < 4) || 'iP' == navigator.platform.slice(0, 2))) ||
      ('Google Inc.' == navigator.vendor && Ob && Ob[1] < 8)
        ? function () {
      ...
      var Pb = function () {
                ...
                var e = D && J[b] ? J[b] : b,
                  f = function (e) {
                    var f = y.doc.documentElement.scrollTop || y.doc.body.scrollTop,
                      ...
                      i = e.clientY + f;
                    if (D && J[x](b))
                      for (var j = 0, k = e.targetTouches && e.targetTouches.length; k > j; j++)
              ...
              ? function (a, b, c, d) {
                  var e = function (a) {
                    ...
                    var b = y.doc.documentElement.scrollTop || y.doc.body.scrollTop,
                      ...
                      g = a.clientY + b;
                    return (
                      (a.preventDefault = a.preventDefault || Pb),
        ...
        Vb = function (a) {
          for (
            ...
            if (((b = Ub[g]), D)) {
              for (var h, i = a.touches.length; i--; )
    ...
    ((Xb.data = function (a, b) {
      ...
      if (1 == arguments.length) {
        if (r.is(a, 'object')) {
          for (var d in a) a[x](d) && this.data(d, a[d]);
          return this;
        }
    ...
    ((Xb.drag = function (a, b, c, d, e, f) {
      function g(g) {
        ...
        ((this._drag.x = g.clientX + i),
          (this._drag.y = g.clientY + h),
          (this._drag.id = g.identifier),
          !Ub.length && r.mousemove(Vb).mouseup(Wb),
          Ub.push({ el: this, move_scope: d, start_scope: e, end_scope: f }),
          b && eve.on('raphael.drag.start.' + this.id, b),
          a && eve.on('raphael.drag.move.' + this.id, a),
          c && eve.on('raphael.drag.end.' + this.id, c),
          eve('raphael.drag.start.' + this.id, e || d || this, g.clientX + i, g.clientY + h, g));
      }
      return ((this._drag = {}), Zb.push({ el: this, start: g }), this.mousedown(g), this);
    }),
    ...
    ((t.getElementByPoint = function (a, b) {
      ...
      (Xb.getBBox = function (a) {
        ...
        return a
          ? ((b.dirty || !b.bboxwt) &&
              ((this.realPath = ob[this.type](this)),
              (b.bboxwt = zb(this.realPath)),
              (b.bboxwt.toString = e),
              (b.dirty = 0)),
            b.bboxwt)
          : ((b.dirty || b.dirtyT || !b.bbox) &&
              ((b.dirty || !this.realPath) &&
                ((b.bboxwt = 0), (this.realPath = ob[this.type](this))),
              (b.bbox = zb(pb(this.realPath, this.matrix))),
              (b.bbox.toString = e),
              (b.dirty = b.dirtyT = 0)),
            b.bbox);
      }),
    ...
    var _b = function (a, b, c, d, e, f, g, h, i) {
        return null == i
          ? k(a, b, c, d, e, f, g, h)
          : r.findDotsAtSegment(a, b, c, d, e, f, g, h, j(a, b, c, d, e, f, g, h, i));
      },
      ac = function (a, b) {
        return function (c, d, e) {
          c = Ib(c);
          for (var f, g, h, i, j, k = '', l = {}, m = 0, n = 0, o = c.length; o > n; n++) {
            if (((h = c[n]), 'M' == h[0])) ((f = +h[1]), (g = +h[2]));
            else {
              if (((i = _b(f, g, h[1], h[2], h[3], h[4], h[5], h[6])), m + i > d)) {
                if (b && !l.start) {
                  if (
                    ((j = _b(f, g, h[1], h[2], h[3], h[4], h[5], h[6], d - m)),
                    (k += ['C' + j.start.x, j.start.y, j.m.x, j.m.y, j.x, j.y]),
                    e)
                  )
                    return k;
                  ((l.start = k),
          ...
          return (
            (l.end = k),
            (j = a ? m : b ? l : r.findDotsAtSegment(f, g, h[0], h[1], h[2], h[3], h[4], h[5], 1)),
            j.alpha && (j = { x: j.x, y: j.y, alpha: j.alpha }),
            j
          );
        };
      },
      ...
      dc = ac(0, 1);
    ((r.getTotalLength = bc),
      (r.getPointAtLength = cc),
      (r.getSubpath = function (a, b, c) {
    ...
    var ec = (r.easing_formulas = {
      ...
      elastic: function (a) {
        return a == !!a ? a : P(2, -10 * a) * L.sin((2 * (a - 0.075) * Q) / 0.3) + 1;
      },
      bounce: function (a) {
        var b,
          c = 7.5625,
    ...
    ((ec.easeIn = ec['ease-in'] = ec['<']),
      (ec.easeOut = ec['ease-out'] = ec['>']),
      (ec.easeInOut = ec['ease-in-out'] = ec['<>']),
      (ec['back-in'] = ec.backIn),
      (ec['back-out'] = ec.backOut));
    var fc = [],
      gc =
      ...
      hc = function () {
        for (var a = +new Date(), c = 0; c < fc.length; c++) {
          var d = fc[c];
          if (!d.el.removed && !d.paused) {
            ...
            if (
              (d.initstatus
                ? ((g = ((d.initstatus * d.anim.top - d.prev) / (d.percent - d.prev)) * h),
                  (d.status = d.initstatus),
                  delete d.initstatus,
                  d.stop && fc.splice(c--, 1))
                : (d.status = (d.prev + (d.percent - d.prev) * (g / h)) / d.anim.top),
              !(0 > g))
            )
              if (h > g) {
                var p = i(g / h);
                    ...
                    switch (bb[q]) {
                      ...
                      case 'colour':
                        e =
                          'rgb(' +
                          [
                            ic(Y(j[q].r + p * h * k[q].r)),
                            ic(Y(j[q].g + p * h * k[q].g)),
                            ic(Y(j[q].b + p * h * k[q].b)),
                          ].join(',') +
                          ')';
                        break;
                      case 'path':
                        e = [];
                        for (var s = 0, t = j[q].length; t > s; s++) {
                          e[s] = [j[q][s][0]];
                          for (var u = 1, v = j[q][s].length; v > u; u++)
                      ...
                      case 'csv':
                        if ('clip-rect' == q)
                          for (e = [], s = 4; s--; ) e[s] = +j[q][s] + p * h * k[q][s];
                        break;
                      default:
                        var y = [][C](j[q]);
                ...
                if (
                  ((function (a, b, c) {
                    setTimeout(function () {
                      (eve('raphael.anim.frame.' + b.id, b, c),
                        eve('raphael.anim.finish.' + b.id, b, c),
                        r.is(a, 'function') && a.call(b));
                    });
                  })(d.callback, m, d.anim),
                  m.attr(l),
                  fc.splice(c--, 1),
                  ...
                  (d.el.attr(o),
                    b(d.anim, d.el, d.anim.percents[0], null, d.totalOrigin, d.repeat - 1));
                }
    ...
    ((Xb.animateWith = function (a, d, e, f, g, h) {
      ...
      (r.animation = function (a, b, d, e) {
        ...
        ((r.is(d, 'function') || !d) && ((e = e || d || null), (d = null)),
          (a = Object(a)),
          (b = +b || 0));
        var f,
          g,
          h = {};
        for (g in a) a[x](g) && Z(g) != g && Z(g) + '%' != g && ((f = !0), (h[g] = a[g]));
        return f ? (d && (h.easing = d), e && (h.callback = e), new c({ 100: h }, b)) : new c(a, b);
      }),
      (Xb.animate = function (a, d, e, f) {
        var g = this;
        if (g.removed) return (f && f.call(g), g);
      ...
      (Xb.pause = function (a) {
        for (var b = 0; b < fc.length; b++)
          fc[b].el.id == this.id &&
            (!a || fc[b].anim == a) &&
            eve('raphael.anim.pause.' + this.id, this, fc[b].anim) !== !1 &&
            (fc[b].paused = !0);
        return this;
      }),
      ...
      (Xb.stop = function (a) {
        for (var b = 0; b < fc.length; b++)
          fc[b].el.id == this.id &&
            (!a || fc[b].anim == a) &&
            eve('raphael.anim.stop.' + this.id, this, fc[b].anim) !== !1 &&
            fc.splice(b--, 1);
        return this;
      }),
      eve.on('raphael.remove', a),
      eve.on('raphael.clear', a),
      (Xb.toString = function () {
    ...
    var jc = function (a) {
        if (((this.items = []), (this.length = 0), (this.type = 'set'), a))
          for (var b = 0, c = a.length; c > b; b++)
            a[b] &&
              (a[b].constructor == Xb.constructor || a[b].constructor == jc) &&
    ...
    ((kc.push = function () {
      for (var a, b, c = 0, d = arguments.length; d > c; c++)
        ((a = arguments[c]),
          a &&
            (a.constructor == Xb.constructor || a.constructor == jc) &&
    ...
    ((kc.attr = function (a, b) {
      ...
      else for (var e = 0, f = this.items.length; f > e; e++) this.items[e].attr(a, b);
      return this;
    }),
      (kc.clear = function () {
          ...
          for (var e in a.glyphs)
            if (a.glyphs[x](e)) {
              ...
              if (
                ...
                for (var g in f.k) f[x](g) && (b.glyphs[e].k[g] = f.k[g]);
            }
        }
        return a;
      }),
        ...
        if (
          ...
          if (e)
            for (
              ...
              j > i &&
              ((h = e[i]),
              h.face['font-weight'] != b ||
                (h.face['font-style'] != c && h.face['font-style']) ||
                h.face['font-stretch'] != d);
              i++
            );
          return h;
        }
      ...
      (t.print = function (a, b, c, d, e, f, g) {
        ...
        return this.path(l).attr({ fill: '#000', stroke: 'none' });
      }),
      (t.add = function (a) {
        if (r.is(a, 'array'))
          for (var b, c = this.set(), d = 0, e = a.length; e > d; d++)
      ...
      z.was ? (y.win.Raphael = r) : (Raphael = r),
      eve.on('raphael.DOMload', function () {
        s = !0;
      }));
  })(),
    ...
    (function (a) {
      ...
      var q = function (d, e) {
          ...
          if ('path' == d.type) {
            ...
            if (
              ...
              a._g.doc.getElementById(A)
                ? p[A]++
                : (n.defs.appendChild(q(q('path'), { 'stroke-linecap': 'round', d: o[w], id: A })),
                  (p[A] = 1));
              var C,
              ...
              (f
                ...
                (k = {}),
                (k['marker-' + r] = 'url(#' + B + ')'),
                (h || g) && (k.d = Raphael.getSubpath(t.path, g, h)),
                q(s, k),
                (d._.arrows[r + 'Path'] = A),
              ...
              (f
                ? ((g = d._.arrows.startdx * u || 0), (h = a.getTotalLength(t.path) - g))
                : ((g = 0), (h = a.getTotalLength(t.path) - (d._.arrows.enddx * u || 0))),
                d._.arrows[r + 'Path'] && q(s, { d: Raphael.getSubpath(t.path, g, h) }),
            ...
            if (f[b](o)) {
              ...
              switch (((k[o] = p), o)) {
                ...
                case 'target':
                  ...
                  'target' == o
                    ? u.setAttributeNS(n, 'show', 'blank' == p ? 'new' : p)
                ...
                case 'cy':
                  ...
                  break;
                case 'r':
                  ('rect' == d.type ? q(i, { rx: p, ry: p }) : i.setAttribute(o, p),
                    (d._.dirty = 1));
                  break;
                case 'src':
                ...
                case 'fill':
                  ...
                  if (F.error) {
                    if (
                      ('circle' == d.type || 'ellipse' == d.type || 'r' != c(p).charAt()) &&
                      r(d, p)
                    ) {
                      if ('opacity' in k || 'fill-opacity' in k) {
                        var G = a._g.doc.getElementById(
                  ...
                  F[b]('opacity') &&
                    q(i, { 'fill-opacity': F.opacity > 1 ? F.opacity / 100 : F.opacity });
                case 'stroke':
                  ((F = a.getRGB(p)),
                    i.setAttribute(o, F.hex),
                    'stroke' == o &&
                      F[b]('opacity') &&
                      q(i, { 'stroke-opacity': F.opacity > 1 ? F.opacity / 100 : F.opacity }),
                    'stroke' == o &&
                      d._.arrows &&
                      ('startString' in d._.arrows && t(d, d._.arrows.startString),
                      'endString' in d._.arrows && t(d, d._.arrows.endString, 1)));
                ...
                case 'fill-opacity':
                  if (k.gradient) {
                    ((G = a._g.doc.getElementById(
                      i.getAttribute('fill').replace(/^url\(#|\)$/g, l)
                    )),
                      G &&
                        ((H = G.getElementsByTagName('stop')),
                        q(H[H.length - 1], { 'stop-opacity': p })));
                    break;
                  }
                default:
        ...
        y = function (d, f) {
          if (
            'text' == d.type &&
            (f[b]('text') || f[b]('font') || f[b]('font-size') || f[b]('x') || f[b]('y'))
          ) {
            var g = d.attrs,
              h = d.node,
              i = h.firstChild
      ...
      ((z.prototype = A),
                ...
                (h[c] =
                  c in this.attrs
                    ...
                    : a.is(this.paper.customAttributes[c], 'function')
                      ? this.paper.customAttributes[c].def
                      : a._availableAttrs[c]));
            return l - 1 ? h : h[g[0]];
          }
        ...
        (A.blur = function (b) {
          ...
          if (0 !== +b) {
            ...
            (c._blur &&
              (c._blur.parentNode.removeChild(c._blur), delete c._blur, delete c.attrs.blur),
        ...
        (a._engine.create = function () {
          ...
          return (
            ...
            (f = f || 512),
            (g = g || 342),
            q(i, { height: g, version: 1.1, width: f, xmlns: 'http://www.w3.org/2000/svg' }),
            1 == c
              ? ((i.style.cssText = j + 'position:absolute;left:' + d + 'px;top:' + e + 'px'),
        ...
        (a.prototype.renderfix = function () {
          ...
          var e = -a.e % 1,
            f = -a.f % 1;
          (e || f) &&
            (e && ((this._left = (this._left + e) % 1), (c.left = this._left + 'px')),
    ...
    (function (a) {
      ...
      var A = function (a, b, d) {
        ...
        B = function (e, i) {
          ...
          var l = e.node,
            ...
            r =
              w[e.type] &&
              (m.cx != i.cx || m.cy != i.cy || m.r != i.r || m.rx != i.rx || m.ry != i.ry),
            s = e;
          ...
          if (
            ...
            ((i.path && 'path' == e.type) || q) &&
              ((l.path = x(
                ~c(m.path).toLowerCase().indexOf('r') ? a._pathToAbsolute(m.path) : m.path
              )),
              'image' == e.type &&
                ((e._.fillpos = [m.x, m.y]),
          ...
          if ('text' == s.type) {
            ...
            ((s.W = m.w = (X.right - X.left) / V),
              ...
              (s.Y = m.y + s.H / 2),
              ('x' in i || 'y' in i) &&
                (s.path.v = a.format('m{0},{1}l{2},{1}', f(m.x * u), f(m.y * u), f(m.x * u) + 1)));
            for (
              var Y = [
                  'x',
                  'y',
              ...
              return (
                ...
                b &&
                  ...
                  h(b - 0.5, 2) + h(c - 0.5, 2) > 0.25 &&
                    (c = e.sqrt(0.25 - h(b - 0.5, 2)) * (2 * (c > 0.5) - 1) + 0.5),
                  (j = b + n + c)),
                o
              );
            })),
      ...
      ((D.prototype = E),
        ...
        (E.transform = function (b) {
          ...
          if ((h.translate(-0.5, -0.5), l || k || 'image' == this.type))
            if (
              ((i.matrix = '1 0 0 1'),
              (i.offset = '0 0'),
              (g = h.split()),
        ...
        (a._engine.setViewBox = function (b, c, d, e, f) {
          ...
          return (
            ...
            (this._viewBoxShift = { dx: -b, dy: -c, scale: l }),
    ...
    ((b = window.Morris = {}),
      ...
      (b.Grid = (function (c) {
        function d(b) {
          ...
          if (
            ((this.el =
              'string' == typeof b.element ? a(document.getElementById(b.element)) : a(b.element)),
          ...
          ('static' === this.el.css('position') && this.el.css('position', 'relative'),
            ...
            this.el.bind('touchstart touchmove touchend', function (a) {
              ...
              return (
                ...
                (b = c.el.offset()),
                c.fire('hover', d.pageX - b.left, d.pageY - b.top),
                d
              );
            }),
        ...
        return (
              ...
              null == a || 0 === a.length
                ...
                : ((o = this.cumulative ? 0 : null),
                  ...
                  this.options.goals.length > 0 &&
                    ((h = Math.min.apply(null, this.options.goals)),
                    (g = Math.max.apply(null, this.options.goals)),
                    ...
                    for (g = [], f = c = 0, d = a.length; d > c; f = ++c)
                      ((j = a[f]),
                        ...
                        (i.y = function () {
                          var a, b, c, d;
                          for (
                            c = this.options.ykeys, d = [], e = a = 0, b = c.length;
                            b > a;
                            e = ++a
                          )
                            ((n = c[e]),
                  ...
                  (this.options.axes === !0 || this.options.grid === !0) &&
            ...
            return (
              ...
              1 > i
                ? ((g = Math.floor(Math.log(i) / Math.log(10))),
                  (f = (function () {
                    var a, b;
                    for (b = [], k = a = e; d >= e ? d >= a : a >= d; k = a += i)
                      b.push(parseFloat(k.toFixed(1 - g)));
                    return b;
                  })()))
                : (f = (function () {
                    var a, b;
                    for (b = [], k = a = e; d >= e ? d >= a : a >= d; k = a += i) b.push(k);
                    return b;
                  })()),
              f
            );
          ...
          (d.prototype.updateHover = function (a, b) {
            ...
            return (
              (c = this.hitTest(a, b)),
              null != c ? (d = this.hover).update.apply(d, c) : void 0
            );
          }),
          (d.prototype.drawGrid = function () {
            var a, b, c, d, e, f;
            if (this.options.grid !== !1 || this.options.axes !== !1) {
              for (e = this.grid, f = [], c = 0, d = e.length; d > c; c++)
                ((a = e[c]),
                  (b = this.transY(a)),
                  this.options.axes &&
                    this.drawYAxisLabel(
                  ...
                  this.options.grid
                    ? f.push(
                        this.drawGridLine(
                          'M' + this.left + ',' + b + 'H' + (this.left + this.width)
                        )
                      )
                    : f.push(void 0));
              return f;
        ...
        return (
          ...
          (c.prototype.moveTo = function (a, b) {
            ...
            return (
              ...
              null != b
                ? ((h = b - c - 10), 0 > h && ((h = b + 10), h + c > f && (h = f / 2 - c / 2)))
                : (h = f / 2 - c / 2),
      ...
      (b.Line = (function (a) {
        function c(a) {
          return (
            (this.hilight = h(this.hilight, this)),
            (this.onHoverOut = h(this.onHoverOut, this)),
            (this.onHoverMove = h(this.onHoverMove, this)),
            (this.onGridClick = h(this.onGridClick, this)),
        ...
        return (
          ...
          (c.prototype.init = function () {
            return (
              (this.pointGrow = Raphael.animation({ r: this.options.pointSize + 3 }, 25, 'linear')),
              (this.pointShrink = Raphael.animation({ r: this.options.pointSize }, 25, 'linear')),
          ...
          (c.prototype.onGridClick = function (a, b) {
            var c;
            return ((c = this.hitTest(a, b)), this.fire('click', c, this.options.data[c], a, b));
          }),
          ...
          (c.prototype.displayHoverForRow = function (a) {
            var b;
            return null != a
              ? ((b = this.hover).update.apply(b, this.hoverContentForRow(a)), this.hilight(a))
          ...
          (c.prototype.hoverContentForRow = function (a) {
            ...
            return (
              'function' == typeof this.options.hoverCallback &&
                (b = this.options.hoverCallback(a, this.options, b)),
              [b, d._x, d._ymax]
            );
          }),
          (c.prototype.generatePaths = function () {
            ...
            return (this.paths = function () {
              var g, h, j, k;
              for (
                k = [], d = g = 0, h = this.options.ykeys.length;
                h >= 0 ? h > g : g > h;
                d = h >= 0 ? ++g : --g
              )
                ((f =
                  this.options.smooth === !0 ||
                  ((j = this.options.ykeys[d]), i.call(this.options.smooth, j) >= 0)),
                  (c = function () {
                    var a, b, c, f;
                    for (c = this.data, f = [], a = 0, b = c.length; b > a; a++)
                      ((e = c[a]), void 0 !== e._y[d] && f.push({ x: e._x, y: e._y[d] }));
                    return f;
                  }.call(this)),
                ...
                a = function (a, b) {
                  ...
                  return (
                    ...
                    0 !== l.options.xLabelAngle &&
                      ((i = -0.5 * j.width * Math.cos((l.options.xLabelAngle * Math.PI) / 180)),
                      c.transform('t' + i + ',0...')),
                    (d = c.getBBox()),
                    (null == f || f >= d.x + d.width || (null != e && e >= d.x)) &&
                    d.x >= 0 &&
          ...
          (c.prototype._drawLineFor = function (a) {
            ...
            return (
              (b = this.paths[a]),
              null !== b ? this.drawLinePath(b, this.colorFor(null, a, 'line')) : void 0
            );
          }),
          (c.createPath = function (a, c, d) {
            var e, f, g, h, i, j, k, l, m, n, o, p, q, r;
            for (
              k = '', c && (g = b.Line.gradients(a)), l = { y: null }, h = q = 0, r = a.length;
              r > q;
              h = ++q
            )
              ((e = a[h]),
            ...
            if (null !== this.prevHilight && this.prevHilight !== a)
              for (
                ...
                this.seriesPoints[b][this.prevHilight] &&
                  this.seriesPoints[b][this.prevHilight].animate(this.pointShrink);
          ...
          (c.prototype.colorFor = function (a, b, c) {
            return 'function' == typeof this.options.lineColors
              ...
              : 'point' === c
                ? this.options.pointFillColors[b % this.options.pointFillColors.length] ||
          ...
          (c.prototype.drawLinePoint = function (a, b, c, d, e) {
            return this.raphael
              .circle(a, b, c)
              .attr('fill', d)
              .attr('stroke-width', this.strokeWidthForSeries(e))
              .attr('stroke', this.strokeForSeries(e));
          }),
      ...
      (b.LABEL_SPECS = {
        ...
        day: {
          ...
          fmt: function (a) {
            return (
              '' + a.getFullYear() + '-' + b.pad2(a.getMonth() + 1) + '-' + b.pad2(a.getDate())
            );
          },
          incr: function (a) {
          ...
          (d.prototype.fillForSeries = function (a) {
            ...
            return (
              ...
              Raphael.hsl(
                ...
                Math.min(0.98, this.options.behaveLikeLine ? 1.2 * b.l : 1.25 * b.l)
              )
            );
          }),
        ...
        function d(c) {
          return (
            ...
            this instanceof b.Bar
              ? (d.__super__.constructor.call(this, a.extend({}, c, { parseTime: !1 })), void 0)
              : new b.Bar(c)
          );
        }
        return (
          ...
          (d.prototype.calc = function () {
            ...
            return (
              ...
              this.options.hideHover === !1
                ? (a = this.hover).update.apply(a, this.hoverContentForRow(this.data.length - 1))
                : void 0
            );
          }),
          ...
          (d.prototype.drawXAxis = function () {
            ...
            for (
              j = this.bottom + this.options.padding / 2,
                g = null,
                f = null,
                m = [],
                a = k = 0,
              ...
              ((h = this.data[this.data.length - 1 - a]),
                ...
                0 !== this.options.xLabelAngle &&
                  ((e = -0.5 * i.width * Math.cos((this.options.xLabelAngle * Math.PI) / 180)),
                  b.transform('t' + e + ',0...')),
          ...
          (d.prototype.drawSeries = function () {
            ...
            return (
              ...
              (h = null != this.options.stacked ? 1 : this.options.ykeys.length),
              (a = (c * this.options.barSizeRatio - this.options.barGap * (h - 1)) / h),
              (g = (c * (1 - this.options.barSizeRatio)) / 2),
              (n = this.ymin <= 0 && this.ymax >= 0 ? this.transY(0) : null),
              (this.bars = function () {
                var h, o, p, q;
                      ...
                      function () {
                        ...
                        for (p = i._y, q = [], j = h = 0, o = p.length; o > h; j = ++h)
                          ((m = p[j]),
                            null !== m
                              ? (n
                                  ? ((l = Math.min(m, n)), (b = Math.max(m, n)))
                                  : ((l = m), (b = this.bottom)),
                                (f = this.left + d * c + g),
                                this.options.stacked || (f += j * (a + this.options.barGap)),
                                (k = b - l),
                                this.options.stacked && (l -= e),
                                this.drawBar(f, l, a, k, this.colorFor(i, j, 'bar')),
                                q.push((e += k)))
                              : q.push(null));
                        return q;
                      }.call(this)
      ...
      (b.Donut = (function (c) {
        function d(c) {
          ((this.select = h(this.select, this)), (this.click = h(this.click, this)));
          var d;
          if (!(this instanceof b.Donut)) return new b.Donut(c);
          if (
            ((this.el =
              'string' == typeof c.element ? a(document.getElementById(c.element)) : a(c.element)),
          ...
          void 0 !== c.data &&
            ...
            (this.values = function () {
              var a, b, c, e;
              for (c = this.data, e = [], a = 0, b = c.length; b > a; a++)
                ((d = c[a]), e.push(parseFloat(d.value)));
              return e;
            }.call(this)),
            this.redraw());
        }
        return (
            ...
            for (
              this.text1 = this.drawEmptyDonutLabel(c, d - 10, this.options.labelColor, 15, 800),
                ...
                h = Math.max.apply(
                  ...
                  function () {
                    var a, b, c, d;
                    for (c = this.values, d = [], a = 0, b = c.length; b > a; a++)
                      ((m = c[a]), d.push(m));
                    return d;
                  }.call(this)
                ),
          ...
          (d.prototype.drawEmptyDonutLabel = function (a, b, c, d, e) {
            var f;
            return (
              (f = this.raphael.text(a, b, '').attr('font-size', d).attr('fill', c)),
      ...
      (b.DonutSegment = (function (a) {
        function b(a, b, c, d, e, f, g, i, j, k) {
          ((this.cx = a),
            ...
            (this.index = j),
            (this.raphael = k),
            (this.deselect = h(this.deselect, this)),
            (this.select = h(this.select, this)),
            (this.sin_p0 = Math.sin(e)),
            (this.cos_p0 = Math.cos(e)),
            (this.sin_p1 = Math.sin(f)),
            (this.cos_p1 = Math.cos(f)),
            (this.is_long = f - e > Math.PI ? 1 : 0),
