((window.CodeMirror = (function () {
  ...
  function a(e, f) {
    ...
    this.options = f = f || {};
    for (var h in _d) !f.hasOwnProperty(h) && _d.hasOwnProperty(h) && (f[h] = _d[h]);
    l(f);
  ...
  function b(a) {
    ...
    (c.setAttribute('wrap', 'off'),
      ...
      (b.scrollbarH = hd('div', [hd('div', null, null, 'height: 1px')], 'CodeMirror-hscrollbar')),
      (b.scrollbarV = hd('div', [hd('div', null, null, 'width: 1px')], 'CodeMirror-vscrollbar')),
      (b.scrollbarFiller = hd('div', null, 'CodeMirror-scrollbar-filler')),
      (b.lineDiv = hd('div')),
      (b.selectionDiv = hd('div', null, null, 'position: relative; z-index: 1')),
      (b.cursor = hd('pre', ' ', 'CodeMirror-cursor')),
      (b.otherCursor = hd('pre', ' ', 'CodeMirror-cursor CodeMirror-secondarycursor')),
      ...
      (b.heightForcer = hd('div', ' ', null, 'position: absolute; height: ' + je + 'px')),
    ...
    return (
      ...
      Fd && ((b.gutters.style.zIndex = -1), (b.scroller.style.paddingRight = 0)),
      a.appendChild ? a.appendChild(b.wrapper) : a(b.wrapper),
      Qd && (c.style.width = '0px'),
      Hd || (b.scroller.draggable = !0),
      Md
        ? ((b.inputDiv.style.height = '1px'), (b.inputDiv.style.position = 'absolute'))
        : Fd && (b.scrollbarH.style.minWidth = b.scrollbarV.style.minWidth = '18px'),
  ...
  function f(a) {
    ...
    a.display.wrapper.className =
      a.display.wrapper.className.replace(/\s*cm-keymap-\S+/g, '') + (b ? ' cm-keymap-' + b : '');
  }
  function g(a) {
    ((a.display.wrapper.className =
  ...
  function i(a) {
    ...
    for (var d = 0; d < c.length; ++d) {
      ...
      'CodeMirror-linenumbers' == e &&
        ((a.display.lineGutter = f), (f.style.width = (a.display.lineNumWidth || 1) + 'px'));
    }
  ...
  function j(a, b) {
    ...
    for (e = b; (c = ic(e)); ) {
      var f = c.find();
      ((d -= e.text.length - f.from.ch), (e = Ec(a, f.to.line)), (d += e.text.length - f.to.ch));
    }
    return d;
  }
  function k(a) {
      ...
      e
        ? ((a.scrollbarH.style.display = 'block'),
          ...
          (a.scrollbarH.firstChild.style.width =
            a.scroller.scrollWidth - a.scroller.clientWidth + a.scrollbarH.clientWidth + 'px'))
        : (a.scrollbarH.style.display = ''),
      e && f
        ? ((a.scrollbarFiller.style.display = 'block'),
          (a.scrollbarFiller.style.height = a.scrollbarFiller.style.width = ld(a.measure) + 'px'))
        : (a.scrollbarFiller.style.display = ''),
      Nd &&
        0 === ld(a.measure) &&
        (a.scrollbarV.style.minWidth = a.scrollbarH.style.minHeight = Od ? '18px' : '12px'));
  }
  function n(a, b, c) {
  ...
  function o(a) {
    ...
    if (b.alignWidgets || b.gutters.firstChild) {
      for (
        ...
        if (f.alignable) for (var g = 0, h = f.alignable; g < h.length; ++g) h[g].style.left = e;
  ...
  function p(a) {
    ...
    if (c.length != d.lineNumChars) {
      var e = d.measure.appendChild(
          hd('div', [hd('div', c)], 'CodeMirror-linenumber CodeMirror-gutter-elt')
        ),
    ...
    return (
      f &&
        ...
        (a.display.showingFrom != d || a.display.showingTo != e) &&
          Xc(a, a, 'viewportChange', a, a.display.showingFrom, a.display.showingTo)),
      y(a),
      m(a.display, a.view.doc.height),
      f
    );
  ...
  function t(a, b, c) {
    var d = a.display,
      e = a.view.doc;
    if (!d.wrapper.clientWidth) return ((d.showingFrom = d.showingTo = d.viewOffset = 0), void 0);
    var f = n(d, e, c);
    if (!(b !== !0 && 0 == b.length && f.from > d.showingFrom && f.to < d.showingTo)) {
      if (
        (b && p(a) && (b = !0),
        (d.sizer.style.marginLeft = d.scrollbarH.style.left = d.gutters.offsetWidth + 'px'),
        b !== !0 && Ud)
      )
      ...
      if (
        ...
        d.showingTo > l && d.showingTo - l < 20 && (l = Math.min(e.size, d.showingTo)),
        Ud)
      )
        for (j = Gc(jc(e, Ec(e, j))); l < e.size && kc(Ec(e, l)); ) ++l;
      for (
        var m = b === !0 ? [] : u([{ from: d.showingFrom, to: d.showingTo }], b), o = 0, g = 0;
        g < m.length;
        ++g
      ) {
        var q = m[g];
      ...
      if (o != l - j || j != d.showingFrom || l != d.showingTo) {
        ...
        var r = j != d.showingFrom || l != d.showingTo || d.lastSizeC != d.wrapper.clientHeight;
        (r && (d.lastSizeC = d.wrapper.clientHeight),
          (d.showingFrom = j),
          (d.showingTo = l),
          C(a, 100));
        for (var s, t = d.lineDiv.offsetTop, v = d.lineDiv.firstChild; v; v = v.nextSibling)
          if (v.lineObj) {
            if (Fd) {
        ...
        return ((d.viewOffset = Ic(a, Ec(e, j))), (d.mover.style.top = d.viewOffset + 'px'), !0);
      }
    }
  }
  function u(a, b) {
  ...
  function w(a, b, c, d, e) {
    ...
    for (
      a.view.doc.iter(b, c, function (b) {
        if ((l && l.to == m && (l = d.shift()), kc(b))) 0 != b.height && Fc(b, 0);
        else if (l && l.from <= m && l.to > m) {
          for (; k.lineObj != b; ) k = f(k);
          (i && m >= e && k.lineNumber && kd(k.lineNumber, q(a.options, m)), (k = k.nextSibling));
        } else {
          var c = x(a, b, m, g);
  ...
  function x(a, b, c, d) {
    var e = xc(a, b),
      ...
      g = a.display;
    if (
      !(a.options.lineNumbers || f || b.bgClass || b.wrapClass || (b.widgets && b.widgets.length))
    )
      return e;
          ...
          l &&
            i.appendChild(
              hd(
                ...
                'left: ' + d.gutterLeft[k] + 'px; width: ' + d.gutterWidth[k] + 'px'
              )
            );
        }
    }
    if (
      (b.bgClass && h.appendChild(hd('div', ' ', b.bgClass + ' CodeMirror-linebackground')),
      h.appendChild(e),
      b.widgets)
    )
      for (var m = 0, n = b.widgets; m < n.length; ++m) {
        ...
        if (((p.widget = o), o.noHScroll)) {
          ...
          ((p.style.left = d.fixedPos + 'px'),
            o.coverGutter ||
              ((r -= d.gutterTotalWidth), (p.style.paddingLeft = d.gutterTotalWidth + 'px')),
            (p.style.width = r + 'px'));
        }
        (o.coverGutter &&
          ((p.style.zIndex = 5),
  ...
  function y(a) {
    ...
    ((b.inputDiv.style.top =
      Math.max(0, Math.min(b.wrapper.clientHeight - 10, d.top + f.top - e.top)) + 'px'),
      (b.inputDiv.style.left =
        Math.max(0, Math.min(b.wrapper.clientWidth - 10, d.left + f.left - e.left)) + 'px'));
  }
  function z(a) {
    var b = a.display,
    ...
    ((b.cursor.style.left = c.left + 'px'),
      ...
      c.other
        ? ((b.otherCursor.style.display = ''),
          ...
          (b.otherCursor.style.height = 0.85 * (c.other.bottom - c.other.top) + 'px'))
  ...
  function A(a) {
      ...
      return (
        nd(Jc(k), d || 0, null == f ? l : f, function (a, c, e) {
          var k = j('rtl' == e ? c - 1 : a),
            ...
            p = n.right;
          (n.top - k.top > 3 &&
            (b(o, k.top, null, k.bottom), (o = i), k.bottom < n.top && b(o, k.bottom, null, n.top)),
            null == f && c == l && (p = h),
            null == d && 0 == a && (o = i),
    ...
    if (f.from.line == f.to.line) c(f.from.line, f.from.ch, f.to.ch);
      ...
      for (var j, k, l = Ec(e, f.from.line), m = l, n = [f.from.line, f.from.ch]; (j = ic(m)); ) {
        var o = j.find();
      ...
      if (k) for (var p = 0; p < n.length; p += 3) c(n[p], n[p + 1], n[p + 2]);
        ...
        var q,
          r,
          s = Ec(e, f.to.line);
        ((q = f.from.ch ? c(f.from.line, f.from.ch, null, !1) : Ic(a, l) - d.viewOffset),
          (r = f.to.ch ? c(f.to.line, hc(s) ? null : 0, f.to.ch, !0) : Ic(a, s) - d.viewOffset),
          r > q && b(i, q, null, r));
      }
    }
  ...
  function D(a) {
    ...
    if (!(b.frontier >= a.display.showingTo)) {
      var d,
        ...
        g = [];
      (c.iter(b.frontier, Math.min(c.size, a.display.showingTo + 500), function (c) {
        return (
          b.frontier >= a.display.showingFrom
            ...
            : (vc(a, c, f), (c.stateAfter = b.frontier % 5 == 0 ? Tb(b.mode, f) : null)),
          ++b.frontier,
  ...
  function F(a, b) {
    ...
    return (
      ...
      c.doc.iter(d, b, function (f) {
        vc(a, f, e);
        var g = d == b - 1 || d % 5 == 0 || (d >= c.showingFrom && d < c.showingTo);
  ...
  function J(a, b) {
    for (var c = a.display, d = a.display.measureLineCache, e = 0; e < d.length; ++e) {
      var f = d[e];
      if (f.text == b.text && f.markedSpans == b.markedSpans && c.scroller.clientWidth == f.width)
        return f.measure;
    }
    var g = K(a, b),
      f = { text: b.text, width: c.scroller.clientWidth, markedSpans: b.markedSpans, measure: g };
  ...
  function K(a, b) {
    ...
    if (Ed && !Fd && !a.options.lineWrapping && e.childNodes.length > 100) {
      for (
        ...
        for (var k = hd('div', null, null, 'display: inline-block'), l = 0; g > l && h; ++l)
  ...
  function M(a, b, c, d) {
    ...
    if (('local' != d && (g -= a.display.viewOffset), 'page' == d)) {
      ...
      var i =
        h.left + (window.pageXOffset || (document.documentElement || document.body).scrollLeft);
      ((c.left += i), (c.right += i));
    }
  ...
  function O(a, b, c, d, e) {
    ...
    for (var i, j, k = g[0].level, l = 0; l < g.length; ++l) {
      ...
      if (q == h)
        ...
        ((n = m && o.level < m.level ? f(m.level % 2 ? m.to - 1 : m.from) : f(p ? h : h - 1, !0)),
          p == k ? (i = n) : (j = n));
      }
    }
  ...
  function P(a, b, c) {
    var d = a.view.doc;
    if (((c += a.display.viewOffset), 0 > c)) return { line: 0, ch: 0, outside: !0 };
    var e = Hc(d, c);
    if (e >= d.size) return { line: d.size - 1, ch: Ec(d, d.size - 1).text.length };
    for (0 > b && (b = 0); ; ) {
      var f = Ec(d, e),
        g = Q(a, f, e, b, c),
        h = ic(f);
  ...
  function Q(a, b, c, d, e) {
    function f(d) {
      ...
      return (
        (h = !0),
        g > e.bottom ? Math.max(0, e.left - i) : g < e.top ? e.left + i : ((h = !1), e.left)
      );
    }
    var g = e - Ic(a, b),
      h = !1,
    ...
    for (;;) {
      if (k ? n == m || n == ud(b, m, 1) : 1 >= n - m) {
        for (var q = p - d > d - o, r = q ? m : n; ne.test(b.text.charAt(r)); ) ++r;
      ...
      var v = f(t);
      v > d ? ((n = t), (p = v), h && (p += 1e3), (l -= s)) : ((m = t), (o = v), (l = s));
    }
  }
  function R(a) {
  ...
  function U(a) {
    ...
    if (!--b.depth) {
      ...
      var c = a.view,
        d = a.display;
      if ((b.updateMaxLine && k(c), c.maxLineChanged && !a.options.lineWrapping)) {
      ...
      ((b.changes.length || (f && null != f.scrollTop)) && (g = s(a, b.changes, f && f.scrollTop)),
      ...
      for (var i = 0; i < b.delayedCallbacks.length; ++i) b.delayedCallbacks[i](a);
    }
  }
  function V(a, b) {
    return function () {
  ...
  function Y(a) {
    function b() {
      var d = Z(a);
      d || c ? ((a.display.pollingFast = !1), X(a)) : ((c = !0), a.display.poll.set(60, b));
    }
    var c = !1;
  ...
  function Z(a) {
    ...
    (T(a), (d.sel.shift = !1));
    for (var g = 0, h = Math.min(c.length, f.length); h > g && c[g] == f[g]; ) ++g;
    var i = e.from,
      j = e.to;
    g < c.length
      ...
      : d.overwrite &&
        ...
        (j = {
          line: j.line,
          ch: Math.min(Ec(a.view.doc, j.line).text.length, j.ch + (f.length - g)),
        });
    var k = a.curOp.updateInput;
    return (
      ub(a, i, j, se(f.slice(g)), 'end', a.display.pasteIncoming ? 'paste' : 'input', {
        from: i,
        to: j,
      }),
      (a.curOp.updateInput = k),
      f.length > 1e3 ? (b.value = a.display.prevInput = '') : (a.display.prevInput = f),
      U(a),
  ...
  function $(a, b) {
    ...
    (zb(e.sel.from, e.sel.to)
      ...
      : ((a.display.prevInput = ''),
        (c = ue && (e.sel.to.line - e.sel.from.line > 100 || (d = a.getSelection()).length > 1e3)),
  ...
  function bb(a) {
    ...
    (Uc(e.scroller, 'mousedown', V(a, eb)),
      ...
      Uc(e.scroller, 'scroll', function () {
        (ib(a, e.scroller.scrollTop), jb(a, e.scroller.scrollLeft, !0), Wc(a, 'scroll', a));
      }),
  ...
  function eb(a) {
    ...
    function d(a) {
      t = 1 / 0;
      var c = db(e, a);
      (c && b(c), Oc(a), _(e), Vc(document, 'mousemove', u), Vc(document, 'mouseup', v));
    }
    var e = this,
      f = e.display,
      g = e.view,
      ...
      if (
        ...
        var p = V(e, function (b) {
          (Hd && (f.scroller.draggable = !1),
            ...
            Math.abs(a.clientX - b.clientX) + Math.abs(a.clientY - b.clientY) < 10 &&
              (Oc(b), Fb(e, j), _(e)));
        });
        return (
    ...
    if (!b.options.onDragEvent || !b.options.onDragEvent(b, Nc(a))) {
      ...
      if (c && !ab(b))
        if (d && d.length && window.FileReader && window.File)
          ...
          if (b.view.draggingText && !Ab(c, b.view.sel.from) && !Ab(b.view.sel.to, c))
            return (b.view.draggingText(a), Ed && setTimeout(ed(_, b), 50), void 0);
          try {
  ...
  function hb(a, b) {
    ...
    (b.dataTransfer.setData('Text', c),
      b.dataTransfer.setDragImage && !Ld && b.dataTransfer.setDragImage(hd('img'), 0, 0));
  }
  function ib(a, b) {
  ...
  function kb(a, b) {
    ...
    if (c && !Dd && !Kd && null != Wd)
      return (
        d && ib(a, Math.max(0, Math.min(f.scrollTop + d * Wd, f.scrollHeight - f.clientHeight))),
        jb(a, Math.max(0, Math.min(f.scrollLeft + c * Wd, f.scrollWidth - f.clientWidth))),
        Oc(b),
        (Bd = null),
        void 0
      );
    if (d && null != Wd) {
      ...
      (0 > g ? (h = Math.max(0, h + g - 50)) : (i = Math.min(a.view.doc.height, i + g + 50)),
        s(a, [], { top: h, bottom: i }));
    }
    20 > Vd &&
      (null == Bd
    ...
    (clearTimeout(Xd),
      e &&
        ...
        (Xd = setTimeout(function () {
          Vb(a.options.keyMap) == d && (a.options.keyMap = e.call ? e.call(null, a) : e);
        }, 50)));
      ...
      (g = Tc(b, 'shiftKey')
        ? Wb(
          ...
          Wb(
            ...
            j,
            function (b) {
              return 'string' == typeof b && /^go[A-Z]/.test(b) ? lb(a, b) : void 0;
            },
            c
          )
        : Wb(
  ...
  function pb(a) {
    ...
    if (
      ...
      Kd &&
        ((Zd = d ? c : null),
        d || 88 != c || ue || !Tc(a, Sd ? 'metaKey' : 'ctrlKey') || b.replaceSelection(''));
    }
  }
  function qb(a) {
    var b = this;
  ...
  function vb(a, b, c, d, e, f) {
    if (!a.view.suppressEdits) {
      ...
      var j = g.sel.from,
        ...
        m = xb(a, b, c, l, e, f);
      return (g.history && Lc(a, b.line, d.length, i, f, j, k, g.sel.from, g.sel.to), m);
    }
  }
  function wb(a, b) {
    var c = a.view.doc,
    ...
    if (e) {
      for (
        ...
        xb(a, { line: h.start, ch: 0 }, { line: j - 1, ch: Ec(c, j - 1).text.length }, h.old, k, b);
      }
  ...
  function xb(a, b, c, d, e, f) {
    ...
    if (!g.suppressEdits) {
      ...
      if (0 == b.ch && 0 == c.ch && '' == mc(p)) {
        for (var r = [], s = 0, t = d.length - 1; t > s; ++s) r.push(rc(mc(d[s]), nc(d[s]), q));
        (sc(a, m, m.text, nc(p)), k && h.remove(b.line, k, a), r.length && h.insert(b.line, r));
      } else if (l == m)
        if (1 == d.length)
          sc(a, l, l.text.slice(0, b.ch) + mc(d[0]) + l.text.slice(c.ch), nc(d[0]));
        else {
          for (var r = [], s = 1, t = d.length - 1; t > s; ++s) r.push(rc(mc(d[s]), nc(d[s]), q));
          (r.push(rc(mc(p) + l.text.slice(c.ch), nc(p), q)),
            sc(a, l, l.text.slice(0, b.ch) + mc(d[0]), nc(d[0])),
            h.insert(b.line + 1, r));
        }
      else if (1 == d.length)
        (sc(a, l, l.text.slice(0, b.ch) + mc(d[0]) + m.text.slice(c.ch), nc(d[0])),
          h.remove(b.line + 1, k, a));
      else {
        var r = [];
        (sc(a, l, l.text.slice(0, b.ch) + mc(d[0]), nc(d[0])),
          sc(a, m, mc(p) + m.text.slice(c.ch), nc(p)));
        for (var s = 1, t = d.length - 1; t > s; ++s) r.push(rc(mc(d[s]), nc(d[s]), q));
      ...
      if (a.options.lineWrapping) {
        ...
        (h.iter(o, b.line + d.length, function (a) {
          var b = j(h, a);
          b > g.maxLineLength &&
            ((g.maxLine = a), (g.maxLineLength = b), (g.maxLineChanged = !0), (n = !1));
        }),
          n && (a.curOp.updateMaxLine = !0));
      ((g.frontier = Math.min(g.frontier, b.line)), C(a, 400));
      var v = d.length - k - 1;
      if ((W(a, b.line, c.line + 1, v), Yc(a, 'change'))) {
        for (var s = 0; s < d.length; ++s) 'string' != typeof d[s] && (d[s] = d[s].text);
      ...
      var y,
        z,
        A = { line: b.line + d.length - 1, ch: mc(p).length + (1 == d.length ? b.ch : 0) };
      if (e && 'string' != typeof e) e.from ? ((y = e.from), (z = e.to)) : (y = z = e);
      else if ('end' == e) y = z = A;
        ...
        var B = function (a) {
          ...
          var d = a.line + v,
            e = a.ch;
          return (
            a.line == c.line && (e += mc(p).length - (c.ch - (c.line == b.line ? b.ch : 0))),
            { line: d, ch: e }
          );
        };
  ...
  function Db(a, b) {
    ...
    if (b.line >= a.size) return { line: a.size - 1, ch: Ec(a, a.size - 1).text.length };
    var c = b.ch,
      d = Ec(a, b.line).text.length;
    return null == c || c > d ? { line: b.line, ch: d } : 0 > c ? { line: b.line, ch: 0 } : b;
  }
  function Eb(a, b) {
    return b >= 0 && b < a.size;
  }
      ...
      if (j.markedSpans) {
        for (var k = 0; k < j.markedSpans.length; ++k) {
          var l = j.markedSpans[k],
            m = l.marker;
          if (
            (null == l.from || (m.inclusiveLeft ? l.from <= g.ch : l.from < g.ch)) &&
            ...
            if (
              ...
              n.ch < 0
                ...
                : n.ch > j.text.length &&
                  (n = n.line < e.size - 1 ? { line: n.line + 1, ch: 0 } : null),
              !n)
            ) {
              if (f) return d ? ((a.view.cantEdit = !0), { line: 0, ch: 0 }) : Ib(a, b, c, !0);
              ((f = !0), (n = b), (h = -h));
            }
            g = n;
            continue a;
  ...
  function Jb(a) {
    ...
    if (b.focused) {
      ...
      if (
        (c.top + e.top < 0
          ? (f = !0)
          : c.bottom + e.top > (window.innerHeight || document.documentElement.clientHeight) &&
            (f = !1),
        null != f && !Pd)
      ) {
  ...
  function Kb(a, b) {
    for (;;) {
      ...
      if (
        ...
        null != e.scrollLeft &&
          (jb(a, e.scrollLeft), Math.abs(a.view.scrollLeft - g) > 1 && (c = !0)),
        !c)
      )
        return d;
    }
  ...
  function Lb(a, b, c, d, e) {
    var f = Mb(a, b, c, d, e);
    (null != f.scrollTop && ib(a, f.scrollTop), null != f.scrollLeft && jb(a, f.scrollLeft));
  }
  ...
  function Nb(a, b, c, d) {
    ...
    var g,
      ...
      j = $c(i.text, null, h),
      k = i.text.match(/^\s*/)[0];
    if ('smart' == c && ((g = a.view.mode.indent(f, i.text.slice(k.length), i.text)), g == ke)) {
      if (!d) return;
      c = 'prev';
    }
    ('prev' == c
    ...
    (g > m && (l += _c(g - m)),
      l != k && yb(a, l, { line: b, ch: 0 }, { line: b, ch: k.length }, 'input'),
      (i.stateAfter = null));
  }
  function Ob(a, b, c) {
    var d = b,
  ...
  function $b(a, b, c, d, e) {
    ...
    (g.replacedWith &&
      ((g.collapsed = !0), (g.replacedWith = hd('span', [g.replacedWith], 'CodeMirror-widget'))),
      g.collapsed && (Ud = !0));
    var i,
      j,
      k = b.line,
    ...
    if (
      (f.iter(k, c.line + 1, function (a) {
        ...
        ((l += a.text.length),
          ...
          g.collapsed &&
            (k == c.line && (j = gc(a, c.ch)), k == b.line ? (i = gc(a, b.ch)) : Fc(a, 0)),
          bc(a, d),
      ...
      g.readOnly &&
        ((Td = !0),
        (a.view.history.done.length || a.view.history.undone.length) && a.clearHistory()),
      g.collapsed)
    ) {
    ...
    return (
      (g.className || g.startStyle || g.endStyle || g.collapsed) && W(a, b.line, c.line + 1),
      g.atomic && Hb(a),
      g
    );
  }
  ...
  function bc(a, b) {
    ((a.markedSpans = a.markedSpans ? a.markedSpans.concat([b]) : [b]), b.marker.lines.push(a));
  }
  function cc(a, b) {
    if (a)
      for (var c, d = 0; d < a.length; ++d) {
        ...
        if (g || ('bookmark' == f.type && e.from == b)) {
          ...
          (c || (c = [])).push({ from: e.from, to: h ? null : e.to, marker: f });
        }
      }
    return c;
  }
    ...
    if (a)
      for (var d, e = 0; e < a.length; ++e) {
        ...
        if (h || ('bookmark' == g.type && f.from == c && f.from != b)) {
          var i = null == f.from || (g.inclusiveLeft ? f.from <= c : f.from < c);
          (d || (d = [])).push({
  ...
  function ec(a, b, c, d, e) {
    ...
    if (!h) {
      ...
      if (o > 0 && f)
        for (var j = 0; j < f.length; ++j)
          null == f[j].to && (n || (n = [])).push({ from: null, to: null, marker: f[j].marker });
  ...
  function lc(a, b) {
    if (null == b.to || (b.marker.inclusiveRight && b.to == a.text.length)) return !0;
  ...
  function nc(a) {
    ...
    for (var b = a.markedSpans, c = null, d = 0; d < b.length; ++d)
      b[d].marker.explicitlyCleared ? c || (c = b.slice(0, d)) : c && c.push(b[d]);
  ...
  function uc(a, b, c) {
    ...
    for ('' == b.text && d.blankLine && d.blankLine(c); !j.eol(); ) {
      ...
      if (
        ...
        e && i == l
          ? (h += m)
          : (h &&
              ((f = f || g >= k.length || h != k[g] || i != k[g + 1]), (k[g++] = h), (k[g++] = i)),
            (h = m),
            (i = l)),
        j.pos > 5e3)
      )
    ...
    return (
      h && ((f = f || g >= k.length || h != k[g] || i != k[g + 1]), (k[g++] = h), (k[g++] = i)),
  ...
  function vc(a, b, c) {
    ...
    for ('' == b.text && d.blankLine && d.blankLine(c); !e.eol() && e.pos <= 5e3; )
  ...
  function xc(a, b, c) {
    ...
    var i = { pre: hd('pre'), col: 0, pos: 0, display: !c, measure: null, addedOne: !1, cm: a };
    ...
    do {
      (g.styles || uc(a, g, (g.stateAfter = F(a, Gc(g)))),
        ...
        c &&
          ...
          g != b &&
          !i.addedOne &&
          ((c[0] = i.pre.appendChild(md(a.display.measure))), (i.addedOne = !0)));
      var j = Bc(g, i);
      ((f = g == e), j && ((g = Ec(a.view.doc, j.to.line)), (h = !1)));
    } while (j);
    return (
      c && !i.addedOne && (c[0] = i.pre.appendChild(h ? hd('span', ' ') : md(a.display.measure))),
      i.pre.firstChild || kc(b) || i.pre.appendChild(document.createTextNode(' ')),
      i.pre
    );
  }
    ...
    if (b) {
      if (ie.test(b))
        for (var f = document.createDocumentFragment(), g = 0; ; ) {
          ...
          if ((i && (f.appendChild(document.createTextNode(b.slice(g, g + i))), (a.col += i)), !h))
            break;
          if (((g += i + 1), '	' == h[0])) {
      ...
      if (c || d || e || a.measure) {
        var m = c || '';
        return (d && (m += d), e && (m += e), a.pre.appendChild(hd('span', [f], m)));
      }
      a.pre.appendChild(f);
    }
  }
  function zc(a, b, c, d, e) {
    for (var f = 0; f < b.length; ++f)
      (f &&
        ...
        (a.measure[a.pos++] = yc(a, b.charAt(f), c, 0 == f && d, f == b.length - 1 && e)));
  ...
  function Bc(a, b) {
    var c = a.styles,
      d = a.markedSpans;
    if (d)
      for (var e, f, g, h, i, j = a.text, k = j.length, l = 0, m = 0, n = '', o = 0; ; ) {
        if (o == l) {
          ((f = g = h = ''), (i = null), (o = 1 / 0));
          for (var p = null, q = 0; q < d.length; ++q) {
            ...
            (r.from <= l && (null == r.to || r.to > l)
              ...
              'bookmark' == s.type && r.from == l && s.replacedWith && (p = s.replacedWith));
          }
          if (
            i &&
            (i.from || 0) == l &&
            (Ac(b, (null == i.to ? k : i.to) - l, null != i.from && i.marker.replacedWith),
            null == i.to)
          )
    ...
    else for (var m = 0; m < c.length; m += 2) b.addToken(b, c[m], wc(c[m + 1]));
  }
  function Cc(a) {
  ...
  function Gc(a) {
    ...
    for (var b = a.parent, c = cd(b.lines, a), d = b.parent; d; b = d, d = d.parent)
  ...
  function Kc() {
    return { done: [], undone: [], lastTime: 0, lastOp: null, lastOrigin: null, dirtyCounter: 0 };
  }
  function Lc(a, b, c, d, e, f, g, h, i) {
    ...
    if (
      l &&
      (j.lastOp == a.curOp.id ||
        (j.lastOrigin == e && ('input' == e || 'delete' == e) && j.lastTime > k - 600))
    ) {
      var m = ad(l.events);
  ...
  function bd(a) {
    Qd ? ((a.selectionStart = 0), (a.selectionEnd = a.value.length)) : a.select();
  }
  function cd(a, b) {
  ...
  function fd(a) {
    return /\w/.test(a) || (a > '' && (a.toUpperCase() != a.toLowerCase() || me.test(a)));
  }
  function gd(a) {
    var b = 0;
  ...
  function hd(a, b, c, d) {
    ...
    if ((c && (e.className = c), d && (e.style.cssText = d), 'string' == typeof b)) kd(e, b);
  ...
  function kd(a, b) {
    Gd ? ((a.innerHTML = ''), a.appendChild(document.createTextNode(b))) : (a.textContent = b);
  }
  function ld(a) {
    if (null != qe) return qe;
    var b = hd('div', null, null, 'width: 50px; height: 50px; overflow-x: scroll');
    return (jd(a, b), b.offsetWidth && (qe = b.offsetHeight - b.clientHeight), qe || 0);
  }
  function md(a) {
    if (null == re) {
      var b = hd('span', '​');
      (jd(a, hd('span', [b, document.createTextNode('x')])),
        0 != a.firstChild.offsetHeight && (re = b.offsetWidth <= 1 && b.offsetHeight > 2 && !Fd));
    }
    return re
      ? hd('span', '​')
      : hd('span', ' ', null, 'display: inline-block; width: 1px; margin-right: -1px');
  }
  function nd(a, b, c, d) {
  ...
  var wd,
    ...
    Qd = /AppleWebKit/.test(navigator.userAgent) && /Mobile\/\w+/.test(navigator.userAgent),
    Rd = Qd || /Android|webOS|BlackBerry|Opera Mini|IEMobile/i.test(navigator.userAgent),
  ...
  a.prototype = {
    ...
    indentSelection: V(null, function (a) {
      ...
      for (var c = b.to.line - (b.to.ch ? 0 : 1), d = b.from.line; c >= d; ++d) Nb(this, d, a);
    }),
    ...
    cursorCoords: function (a, b) {
      var c,
        d = this.view.sel;
      return (
        (c = null == a ? d.head : 'object' == typeof a ? Db(this.view.doc, a) : a ? d.from : d.to),
        O(this, c, b || 'page')
      );
    },
    ...
    setBookmark: V(null, function (a, b) {
      return ((a = Db(this.view.doc, a)), $b(this, a, a, b ? { replacedWith: b } : {}, 'bookmark'));
    }),
    findMarksAt: function (a) {
      ...
      if (d)
        for (var e = 0; e < d.length; ++e) {
          var f = d[e];
          (null == f.from || f.from <= a.ch) && (null == f.to || f.to >= a.ch) && c.push(f.marker);
        }
      return c;
    },
    ...
    addWidget: function (a, b, c, d, e) {
      ...
      if (((b.style.position = 'absolute'), f.sizer.appendChild(b), 'over' == d)) g = a.top;
        ...
        (a.bottom + b.offsetHeight > i && a.top > b.offsetHeight && (g = a.top - b.offsetHeight),
    ...
    setCursor: V(null, function (a, b, c) {
      var d = Db(this.view.doc, 'number' == typeof a ? { line: a, ch: b || 0 } : a);
    ...
    setLine: V(null, function (a, b) {
      Eb(this.view.doc, a) &&
        yb(this, b, { line: a, ch: 0 }, { line: a, ch: Ec(this.view.doc, a).text.length });
    }),
    removeLine: V(null, function (a) {
      Eb(this.view.doc, a) &&
        yb(this, '', { line: a, ch: 0 }, Db(this.view.doc, { line: a + 1, ch: 0 }));
    }),
    ...
    moveH: V(null, function (a, b) {
      var c = this.view.sel,
        d = 0 > a ? c.from : c.to;
      ((c.shift || c.extend || zb(c.from, c.to)) && (d = Pb(this, a, b, !0)), Fb(this, d, d, a));
    }),
    ...
    scrollTo: function (a, b) {
      (null != a && (this.display.scrollbarH.scrollLeft = this.display.scroller.scrollLeft = a),
        null != b && (this.display.scrollbarV.scrollTop = this.display.scroller.scrollTop = b),
        s(this, []));
    },
      ...
      return (
        ...
        (i.toTextArea = function () {
          (d(),
            ...
            (b.style.display = ''),
            b.form &&
              (Vc(b.form, 'submit', d), 'function' == typeof b.form.submit && (b.form.submit = h)));
        }),
        i
      );
    }),
      ...
      if (!this.explicitlyCleared) {
        ...
        for (var a = null, b = null, c = 0; c < this.lines.length; ++c) {
          ...
          (null != e.to && (b = Gc(d)),
            ...
            null != e.from ? (a = Gc(d)) : this.collapsed && !kc(d) && Fc(d, R(this.cm.display)));
        }
        (null != a && W(this.cm, a, b + 1),
          (this.lines.length = 0),
          (this.explicitlyCleared = !0),
          this.collapsed && this.cm.view.cantEdit && ((this.cm.view.cantEdit = !1), Hb(this.cm)),
          U(this.cm),
  ...
  ((Cc.prototype = {
    ...
    (Dc.prototype = {
      ...
      remove: function (a, b, c) {
        ...
        if (this.size - b < 25) {
          var i = [];
          (this.collapse(i), (this.children = [new Cc(i)]), (this.children[0].parent = this));
        }
      },
      collapse: function (a) {
  ...
  var we = (function () {
    ...
    return function (b) {
      ...
      for (var l = 0, n = k; i > l; ++l) {
        var c = j[l];
        '1' == c && 'r' == n ? (j[l] = 'n') : f.test(c) && ((n = c), 'r' == c && (j[l] = 'R'));
      }
      ...
      for (var l = 0; i > l; ++l) {
        ...
        if (',' == c) j[l] = 'N';
          ...
          for (
            var p = (l && '!' == j[l - 1]) || (i - 1 > o && '1' == j[o]) ? '1' : 'N', q = l;
            o > q;
            ++q
          )
            j[q] = p;
      ...
      return (
        1 == u[0].level &&
          (t = b.match(/^\s+/)) &&
          ((u[0].from = t[0].length), u.unshift({ from: 0, to: t[0].length, level: 0 })),
        1 == ad(u).level &&
          (t = b.match(/\s+$/)) &&
          ((ad(u).to -= t[0].length), u.push({ from: i - t[0].length, to: i, level: 0 })),
        u[0].level != ad(u).level && u.push({ from: i, to: i, level: u[0].level }),
        u
      );
    };
  })();
  ...
  CodeMirror.defineMode('javascript', function (a, b) {
    ...
    function f(a, b) {
      ...
      if (/\d/.test(f) || ('-' == f && a.eat(/\d/)))
        return (a.match(/^\d*(?:\.\d*)?(?:[eE][+\-]?\d+)?/), e('number', 'number'));
      if ('/' == f)
        return a.eat('*')
          ? c(a, b, h)
          : a.eat('/')
      ...
      (r.lex = !0),
      {
        ...
        indent: function (a, b) {
          ...
          var e = d.type,
            g = c == e;
          return 'vardef' == e
            ? d.indented + ('operator' == a.lastType || ',' == a.lastType ? 4 : 0)
            : 'form' == e && '{' == c
              ? d.indented
              : 'form' == e
                ? d.indented + O
                : 'stat' == e
                  ? d.indented + ('operator' == a.lastType || ',' == a.lastType ? O : 0)
                  : 'switch' != d.info || g
                    ? d.align
                      ? d.column + (g ? 0 : 1)
                      : d.indented + (g ? 0 : O)
  ...
  (function () {
      ...
      if (
        ...
        (b.global || (b = new RegExp(b.source, b.ignoreCase ? 'ig' : 'g')),
          (this.matches = function (c, d) {
            if (c) {
              b.lastIndex = 0;
              for (var e = a.getLine(d.line).slice(0, d.ch), f = b.exec(e), g = 0; f; ) {
          ...
          1 == f.length
            ? function (c, d) {
                ...
                return (
                  ...
                  ? { from: { line: d.line, ch: f }, to: { line: d.line, ch: f + h } }
                  : void 0;
              }
            : function (b, c) {
                var d = c.line,
                ...
                if (!(b ? j >= c.ch || j != h.length : j <= c.ch || j != i.length - h.length))
                  for (;;) {
    ...
    ((a.prototype = {
      ...
      find: function (a) {
        ...
        for (var c = this, d = this.cm.clipPos(a ? this.pos.from : this.pos.to); ; ) {
